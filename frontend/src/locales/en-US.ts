...
export default {
  ...
  layout: {
    ...
    menu: {
      ...
      labDip: 'Lab Dip',
      bulkColorApproval: 'Bulk Color Approval',
      productionRecipes: 'Production Recipes',
      quality8d: 'Quality 8D',
      outsourcing: 'Outsourcing',
      wage: 'Piece Wage',
      fabricInspections: 'Fabric Inspections',
      chemicals: 'Chemicals',
      exportCompliance: 'Export Compliance',
      supplierEnhanced: 'Supplier 360',
      crmEnhanced: 'CRM Analytics',
      customerCollab: 'Signatures & Sharing',
      badDebts: 'Bad Debts',
      periodAdjustments: 'Period Adjustments',
      budgetApprovals: 'Budget Approval',
      invoiceDetails: 'Invoices',
      accountingPeriods: 'Accounting Periods',
      systemGovernance: 'System Governance',
      laborContracts: 'Labor Contracts',
  ...
  sales: {
    ...
    orderForm: {
      ...
      colorNo: 'Color No.',
      colorNoPlaceholder: 'Leave empty for greige fabric',
      colorLoadFailed: 'Failed to load product color list',
    },
    orderDetail: {
  ...
  inventory: {
    ...
    alertTab: {
      ...
      alertTypeNormal: 'Normal',
      alertTypeLowStock: 'Below Reorder Point',
      alertTypeOutOfStock: 'Out of Stock',
      alertTypeOverStock: 'Over Maximum Stock',
      alertTypeSlowMoving: 'Slow Moving',
      alertTypeExpiring: 'Expiring Soon',
      alertTypeDiscrepancy: 'Count Discrepancy / Abnormal Status',
      colOperation: 'Action',
      purchase: 'Purchase',
    ...
    reservation: {
      ...
      remark: 'Remark',
      lock: 'Lock',
      lockSuccess: 'Reservation locked',
      release: 'Release',
    ...
    stockDetail: {
      ...
      color: 'Color: {value}',
      dyeLot: 'Dye Lot: {value}',
      qtyMeters: 'Quantity (m): {value}',
      qtyKg: 'Quantity (kg): {value}',
  ...
  finance: {
    ...
    subjectTab: {
      ...
      assistCustomer: 'Assist Customer',
      assistSupplier: 'Assist Supplier',
      assistBatch: 'Assist Batch',
      assistColorNo: 'Assist Color No.',
      enableDualUnit: 'Dual Unit Accounting',
  ...
  message: {
    ...
    // V15 batch 07 P1-9: high-frequency ElMessage phrases (i18n centralized)
    ...
    printWindowBlocked: 'Unable to open print window, please check popup blocker settings',
    printWindowOpened: 'Print window opened',
    noDataToExport: 'No data to export',
    noDataToPrint: 'No data to print',
    pleaseSelectWarehouse: 'Please select a receiving warehouse',
    pleaseFillItem: 'Please fill in at least one received quantity',
    ...
    keepAtLeastTwoEntries: 'Keep at least two entries',
    pleaseAddEntry: 'Please add at least one valid entry',
    // V15 batch 07 P1: business high-frequency phrases
    issueSuccess: 'Issue successful',
    returnSuccess: 'Return successful',
    lostRecorded: 'Lost recorded',
    damagedMarked: 'Marked as damaged',
    issueCancelled: 'Issue cancelled',
    loadMaterialShortageFailed: 'Failed to load material shortage list',
    notificationSent: 'Notification sent',
    markedAsResolved: 'Marked as resolved',
    noSalesTargetToEdit: 'No sales target to edit',
    ...
    loadScheduleTaskFailed: 'Failed to load schedule tasks',
    scheduleAdjustedSuccess: 'Schedule adjusted successfully',
    scheduleConflict: 'Work order {orderNo} has schedule conflict: {details}',
    ...
    optimizationSuggestionsGenerated: 'Optimization suggestions generated',
    detectionComplete: 'Detection complete',
    recommendationsFetched: 'Recommendations fetched',
    pleaseInputColorCode: 'Please input color code',
    pleaseSelectFabric: 'Please select fabric',
    recommendationGenerated: 'Recommendation generated',
    securityTokenExpired: 'Security token expired, please login again',
    ...
    importTaskCreated: 'Import task created',
    taskCancelled: 'Task cancelled',
    taskRestarted: 'Task restarted',
    errorLogDownloaded: 'Error log downloaded successfully',
    invalidRequestSchema: 'Invalid request schema format',
    invalidResponseSchema: 'Invalid response schema format',
    ...
    loadVoucherListFailed: 'Failed to load voucher list',
    generateVoucherNoFailed: 'Failed to generate voucher number',
    postSuccess: 'Posting successful',
    postedVoucherCannotDelete: 'Posted voucher cannot be deleted',
    bookSuccess: 'Bookkeeping successful',
    unbookSuccess: 'Unbookkeeping successful',
    ...
    installTaskCreated: 'Install task created',
    ...
    // V15 batch 07 P1: business process high-frequency phrases
    ...
    receiveFailed: 'Receipt failed',
    predictionFailed: 'Prediction failed',
    generationFailed: 'Generation failed',
    detectionFailed: 'Detection failed',
    fetchFailed: 'Fetch failed',
    recommendationFailed: 'Recommendation failed',
    tfaEnabledSuccess: '2FA enabled successfully',
    verifyFailedRetry: 'Verification failed, please retry',
    verifyFailedCheckToken: 'Verification failed, please check if the token is correct',
    ...
    loadSalesPriceListFailed: 'Failed to load sales price list',
    loadConflictListFailed: 'Failed to load conflict list',
    loadGanttDataFailed: 'Failed to load Gantt chart data',
    loadHistoryFailed: 'Failed to load history',
    loadPriceStrategyFailed: 'Failed to load price strategy',
    loadPurchaseOrderListFailed: 'Failed to load purchase order list',
    loadCapacityOverviewFailed: 'Failed to load capacity overview',
    loadCapacityTrendFailed: 'Failed to load capacity trend',
    loadBottleneckAnalysisFailed: 'Failed to load bottleneck analysis',
    loadApiEndpointFailed: 'Failed to load API endpoints',
    loadApiKeyFailed: 'Failed to load API keys',
    loadApiLogFailed: 'Failed to load API logs',
    loadVersionListFailed: 'Failed to load version list',
    loadBackupListFailed: 'Failed to load backup list',
    loadReturnListFailed: 'Failed to load return list',
    createVersionFailed: 'Failed to create version',
    activateVersionFailed: 'Failed to activate version',
  ...
  inventoryTransfer: {
    ...
    transferForm: {
      ...
      serverItemsDivider: 'Saved Items (Server)',
      colProductId: 'Product ID',
      colQuantity: 'Qty',
      colShipped: 'Shipped Qty',
    ...
    transferList: {
      ...
      message: {
        ...
        deleteConfirm: 'Delete this transfer order?',
        deleteTitle: 'Confirm Deletion',
        shipConfirm: 'Ship this transfer order? Stock will be moved per the items.',
        shipTitle: 'Confirm Shipment',
        shipSuccess: 'Shipped successfully',
        generateNoTitle: 'Pre-generated Transfer No.',
      },
    },
  },
  cost: {
  ...
  bpm: {
    ...
    stats: {
      ...
      minuteUnit: ' min',
      noSample: 'No completed samples yet',
    },
    tab: {
    ...
    message: {
      ...
      urgeMessage: 'Please handle this task as soon as possible',
      ...
      fetchMonitorStatsFailed: 'Failed to fetch monitor stats',
      fetchMonitorPendingFailed: 'Failed to fetch monitor pending tasks',
      processKeyRequired: 'Please enter process key',
      businessTypeRequired: 'Please enter business type',
      businessIdRequired: 'Please enter business ID',
      processTitleRequired: 'Please enter process title',
      currentUserMissing: 'Current logged-in user is unavailable, please log in again',
      startProcessSuccess: 'Process started, instance ID: {instanceId}',
      startProcessFailed: 'Failed to start process',
      businessRelationInputRequired: 'Please enter business type and ID',
      businessRelationNotFound: 'No related process instance found',
      fetchBusinessRelationFailed: 'Failed to query business relation',
    },
    startProcessDialog: {
      title: 'Start Process',
      ariaLabel: 'Start Process Dialog',
      formAriaLabel: 'Start Process Form',
      processKey: 'Process Key',
      processKeyPlaceholder: 'Please enter process key',
      businessType: 'Business Type',
      businessTypePlaceholder: 'Please enter business type',
      businessId: 'Business ID',
      businessIdPlaceholder: 'Please enter business ID',
      processTitle: 'Process Title',
      processTitlePlaceholder: 'Please enter process title',
      cancel: 'Cancel',
      confirm: 'Start',
    },
    businessRelationDialog: {
      title: 'Business Relation Query',
      ariaLabel: 'Business Relation Dialog',
      formAriaLabel: 'Business Relation Form',
      businessType: 'Business Type',
      businessTypePlaceholder: 'Please enter business type',
      businessId: 'Business ID',
      businessIdPlaceholder: 'Please enter business ID',
      query: 'Query',
      hasProcess: 'Has Related Process',
      yes: 'Yes',
      no: 'No',
      instanceId: 'Instance No.',
      status: 'Status',
      startTime: 'Start Time',
      endTime: 'End Time',
      taskProgress: 'Task Progress (done / total)',
    },
    nodeType: {
      start: 'Start',
      end: 'End',
  ...
  quality: {
    ...
    recordDialog: {
      ...
      ruleNo: 'Inspection no. is required',
      ruleType: 'Please select the inspection type',
      ruleProduct: 'Please select the product',
      ruleDate: 'Please select the inspection date',
      ruleTotalQty: 'Total quantity is required',
      ruleInspectedQty: 'Inspected quantity is required',
      ruleResult: 'Please select the inspection result',
    },
    standardStatus: {
      draft: 'Draft',
      approved: 'Approved',
  ...
  product: {
    ...
    productListTab: {
      ...
      buttonAdd: 'Add',
      buttonSave: 'Save',
      buttonBatchColors: 'Batch Add Colors',
      batchColorsPlaceholder:
        'JSON array, e.g. [{\'{\'}"color_no":"R001","color_name":"Red"{\'}\'},{\'{\'}"color_no":"B002","color_name":"Blue"{\'}\'}]',
      batchColorsInvalid: 'Please enter a valid JSON array (1+ items)',
      colorDeleteConfirm: 'Delete color "{no}"?',
      colorDeleteTitle: 'Delete Confirmation',
      batchProductTitle: 'Batch Maintain Products',
      batchProductCreate: 'Batch Create',
      batchProductUpdate: 'Batch Update',
      batchProductPlaceholder:
        'JSON array; create requires product_code/product_name; update requires id',
      buttonDetail: 'Detail',
      buttonEdit: 'Edit',
      buttonDelete: 'Delete',
      buttonBatchDelete: 'Batch Delete',
      paginationAriaLabel: 'Product list pagination',
      messageFetchFailed: 'Failed to fetch product list',
      messageColorNoRequired: 'Please enter color no.',
      messageSelectFirst: 'Please select products to delete first',
      messageBatchDeleteConfirm: 'Delete {count} selected products?',
    ...
    categoryDialogTab: {
      ...
      messageRenamePrompt: 'Please enter new category name',
  ...
  colorPrices: {
    ...
    seasonalRules: {
      ...
      dialog: {
        createTitle: 'Create Seasonal Rule',
        editTitle: 'Edit Seasonal Rule',
        ruleName: 'Rule Name',
        season: 'Season',
        categoryId: 'Category ID',
        adjustType: 'Adjustment Type',
    ...
    customerSpecial: {
      ...
      dialog: {
        createTitle: 'Create Customer Special Price',
        customerId: 'Customer ID',
        productId: 'Product ID',
        colorId: 'Color ID',
        specialPrice: 'Special Price',
  ...
  setupPage: {
    ...
    validation: {
      ...
      passwordComplexity: 'Requires uppercase, lowercase, digit & special character',
  ...
  advancedModule: {
    ...
    subscription: {
      ...
      weekly: 'Weekly',
      monthly: 'Monthly',
      fillRequired: 'Please fill in the subscription name, template ID and recipients',
      enabledMsg: 'Subscription enabled',
      disabledMsg: 'Subscription disabled',
    },
  },
  ...
  bomModule: {
    ...
    approve: {
      ...
      submitConfirm: 'Submit BOM (version {version}) for review?',
      submitSuccess: 'BOM submitted for review',
  ...
  actionForm: {
    ...
    approveAsk: 'Choose an approval decision (both approve and reject are recorded)',
    approvePass: 'Approve',
    approveReject: 'Reject',
    approveRemarkTitle: 'Approval comment',
    approveRemarkTip: 'Approval comment (optional)',
    executeTypeTitle: 'Execution type',
    executeTypeTip: 'Please select the execution type',
    executeTypePartial: 'Partial execution',
    executeTypeComplete: 'Complete execution',
    executeTypeDelivery: 'Delivery',
    executeTypePayment: 'Payment',
    executeAmountTitle: 'Execution amount',
    executeAmountTip: 'Enter this execution amount (must be greater than zero)',
    executeAmountPlaceholder: 'Enter execution amount',
    executeAmountRequired: 'Execution amount is required',
    executeAmountPositive: 'Execution amount must be a number greater than zero',
    executeDateTitle: 'Execution date',
    executeDateTip: 'Enter the execution date (format: year-month-day)',
    executeDatePlaceholder: 'e.g. 2026-09-23',
    executeDateRequired: 'Execution date is required',
    executeDateInvalid: 'Date format should be YYYY-MM-DD',
    executeRemarkTitle: 'Execution remark',
    executeRemarkTip: 'Execution remark (optional)',
  },
  apModule: {
    tabs: {
      invoice: 'AP Invoice',
    ...
    invoice: {
      ...
      autoGenerateConfirm:
        'Generate AP invoices from approved purchase receipts in batch. Continue?',
      autoGenerateSuccess: 'Auto generation completed',
      ...
      agingInvoiceCount: 'Invoice Count',
      agingAmount: 'Amount',
    },
    payment: {
    ...
    report: {
      ...
      emptyTip: 'Click search to load report data',
    },
    verification: {
      ...
      autoVerifyConfirm: 'Match due invoices against payments automatically. Continue?',
      autoVerifySuccess: 'Auto verification completed',
  ...
  arModule: {
    ...
    verification: {
      ...
      autoConfirm: 'Match unverified invoices against receipts automatically. Continue?',
      autoSuccess: 'Auto verification completed',
      invoiceNo: 'Invoice No.',
      paymentNo: 'Receipt No.',
  ...
  crmAssignment: {
    ...
    batchAssign: {
      ...
      idsPlaceholder: 'Separate IDs with commas, e.g. 1,2,3',
      assignTo: 'Assign To',
      cancel: 'Cancel',
      confirm: 'Assign',
      required: 'Please enter customer IDs and select a sales user',
      success: '{count} customers assigned',
      failed: 'Batch assign failed',
    },
    strategy: {
      average: 'Average',
      region: 'By Region',
  ...
  crmRuleDialog: {
    ...
    form: {
      ...
      days: 'Recycle Days',
      daysPlaceholder: 'Recycle after N days idle',
      daysTip: 'Customers will be recycled to the pool after N days without follow-up',
      strategy: 'Strategy',
    ...
    validation: {
      ...
      daysRequired: 'Please enter recycle days',
    ...
    index: {
      ...
      dialog: {
        ...
        deleteConfirmMessage:
          'Are you sure you want to delete this customer credit? This cannot be undone.',
        deleteConfirmTitle: 'Dangerous Action',
        evaluateConfirmMessage: 'Are you sure you want to re-evaluate this customer credit?',
        evaluateConfirmTitle: 'Credit Evaluation',
        confirm: 'Confirm',
        cancel: 'Cancel',
      },
    },
  ...
  security: {
    alertTable: {
      ...
      confirmResolve: 'Mark alert #{id} as resolved?',
      column: {
        index: 'Index',
    ...
    lockTable: {
      ...
      confirmUnlock: 'Unlock account {username}?',
      column: {
        index: 'Index',
        username: 'Username',
    ...
    logTable: {
      ...
      downloadFilename: 'login-logs.csv',
    },
    stat: {
      label: {
  ...
  purchaseInspection: {
    ...
    complete: {
      ...
      passQuantityTip: 'Enter the passed quantity',
      passQuantityPlaceholder: 'Passed quantity (required, ≥ 0)',
      rejectQuantityTip: 'Enter the failed quantity',
      rejectQuantityPlaceholder: 'Failed quantity (required, ≥ 0)',
      numberError: 'Please enter a valid non-negative number',
      resultTip: 'Enter the inspection result (pass / fail / partial)',
      resultPlaceholder: 'Inspection result (required)',
      resultError: 'Only pass / fail / partial are allowed',
    },
  },
  purchasePrice: {
    index: {
  ...
  logistics: {
    ...
    detail: {
      ...
      events: {
        sectionTitle: 'Shipment Trace',
        recordEvent: 'Record Event',
        linkPo: 'Link Purchase Order',
        colTime: 'Time',
        colType: 'Type',
        colLocation: 'Location',
        colDescription: 'Description',
        dialogTitle: 'Record Tracking Event',
        fieldType: 'Event Type',
        fieldTime: 'Occurred At',
        linkPoPlaceholder: 'Purchase order ID',
        typePickup: 'Pickup',
        typeInTransit: 'In Transit',
        typeArrived: 'Arrived',
  ...
  fabric: {
    ...
    index: {
      ...
      labelLengthM: 'Length (m)',
      placeholderWarehouse: 'Please select a warehouse',
      messageWarehouseRequired: 'Please select a warehouse',
      messageWeightMustBePositive: 'Weight must be a positive number',
      messageLengthMustBePositive: 'Length must be a positive number',
      messageAtLeastOneOfWeightOrLength: 'Fill in at least weight or length',
      messageWeightAndLengthMustBePositive: 'Weight and length must be positive numbers',
      fetchGreigeFabricsFailed: 'Failed to fetch greige fabric list',
      fetchSuppliersFailed: 'Failed to fetch suppliers',
      fetchWarehousesFailed: 'Failed to fetch warehouses',
    },
    dyeTab: {
      ...
      statusPendingSchedule: 'Pending Schedule',
      statusScheduled: 'Scheduled',
      statusPreparing: 'Preparing',
      statusDyeing: 'Dyeing',
      statusWashing: 'Washing',
      statusFixing: 'Fixing',
      statusDehydrating: 'Dehydrating',
      statusDrying: 'Drying',
    ...
    greigeTab: {
      ...
      columnWeightKg: 'Weight (kg)',
      columnLengthM: 'Length (m)',
      columnStatus: 'Status',
      columnAction: 'Action',
      buttonEdit: 'Edit',
    ...
    recipeTab: {
      ...
      messageApproveFailed: 'Approval failed',
      messageNoUserInfo: 'Unable to get current user info, please log in again',
  ...
  financialAnalysis: {
    ...
    analysisListTab: {
      ...
      buttonParamExec: 'Execute with Params',
  ...
  salesReturns: {
    ...
    detailDialog: {
      ...
      buttonDeleteItem: 'Delete',
      buttonEditItem: 'Edit',
      buttonUpdateItem: 'Save Changes',
      buttonCancelEdit: 'Cancel Edit',
      itemSuccess: 'Operation successful',
      itemFailed: 'Operation failed',
      deleteItemConfirm: 'Delete this return item?',
      deleteItemTitle: 'Confirm Deletion',
      ...
      taxPercentPlaceholder: 'Tax rate % (empty = order tax rate)',
    },
    editDialog: {
  ...
  trading: {
    ...
    purchaseContractTab: {
      ...
      messageDeleteSuccess: 'Deleted successfully',
      buttonEdit: 'Edit',
      editDialogTitle: 'Edit Purchase Contract',
      buttonCancel: 'Cancel',
      buttonConfirm: 'Confirm',
      messageEditSuccess: 'Updated successfully',
      executeTypeTip: 'Enter the execution type (receipt = stock-in / payment = payment)',
      executeTypePlaceholder: 'Execution type (required)',
      executeTypeRequired: 'Execution type cannot be empty',
      executeAmountTip: 'Enter the execution amount for contract {no}',
      executeAmountPlaceholder: 'Execution amount (required, greater than 0)',
      executeAmountInvalid: 'Please enter a valid amount (up to two decimal places)',
      executeDateTip: 'Enter the execution date',
      executeDatePlaceholder: 'Execution date (YYYY-MM-DD, required)',
    },
    purchasePriceTab: {
      title: 'Purchase Price Management',
      ...
      confirmApproveText: 'Are you sure you want to approve the price for {name}?',
      messageApproveSuccess: 'Approved successfully',
      confirmDeleteTitle: 'Delete Confirmation',
      confirmDeleteText: 'Are you sure you want to delete the price for {name}?',
      messageDeleteSuccess: 'Deleted successfully',
    },
    salesContractTab: {
      ...
      messageDeleteSuccess: 'Deleted successfully',
      buttonEdit: 'Edit',
      editDialogTitle: 'Edit Sales Contract',
      buttonCancel: 'Cancel',
      buttonConfirm: 'Confirm',
      messageEditSuccess: 'Updated successfully',
      executeTypeTip: 'Enter the execution type (delivery = stock-out / payment = receipt)',
      executeTypePlaceholder: 'Execution type (delivery / payment, required)',
      executeTypeInvalid: 'Execution type must be delivery or payment',
      executeAmountTip: 'Enter the execution amount for contract {no}',
      executeAmountPlaceholder: 'Execution amount (required, greater than 0)',
      executeAmountInvalid: 'Please enter a valid amount (up to two decimal places)',
    },
  ...
  flowCards: {
    index: {
      pageTitle: 'Flow Card Management',
      placeholderAllStatus: 'All statuses',
      buttonCreate: 'New Flow Card',
      titleCreate: 'New Flow Card',
      titleDetail: 'Flow Card Detail',
      colCardNo: 'Flow Card No.',
      colProductionOrder: 'Production Order',
      colProduct: 'Product',
      colColorNo: 'Color No.',
      colDyeLotNo: 'Dye Lot No.',
      colPlannedWeight: 'Planned Weight (kg)',
      labelProductionOrderId: 'Production Order ID',
      labelProductId: 'Product ID',
      labelProductName: 'Product Name',
      labelBarcode: 'Barcode',
      labelCustomer: 'Customer',
      labelActualWeight: 'Actual Weight (kg)',
      labelCurrentStepSeq: 'Current Step Seq.',
      labelDyeingRequirements: 'Dyeing Requirements',
      placeholderRequired: 'Required',
      placeholderOptional: 'Optional',
      buttonConfirm: 'Confirm',
      buttonSchedule: 'Schedule',
      buttonTerminate: 'Terminate',
      buttonConfirmTerminate: 'Confirm Termination',
      buttonStartPreparing: 'Start Preparing',
      buttonCompletePreparing: 'Finish Preparation',
      buttonStartDyeing: 'Start Dyeing',
      buttonCompleteDyeing: 'Complete Dyeing',
      buttonStartInspecting: 'Start Inspection',
      buttonCompleteInspecting: 'Complete Inspection',
      buttonShip: 'Ship',
      buttonReactivate: 'Reactivate',
      buttonConfirmDelete: 'Confirm Deletion',
      statusPending: 'Pending Scheduling',
      statusScheduled: 'Scheduled',
      statusPreparing: 'Preparing Fabric',
      statusDyeing: 'Dyeing',
      statusDyed: 'Out of Dye Lot',
      statusInspecting: 'Inspecting',
      statusCompleted: 'Completed',
      statusShipped: 'Shipped',
      statusTerminated: 'Terminated',
      titleTerminateConfirm: 'Termination Confirmation',
      titleActionConfirm: 'Operation Confirmation',
      titleDeleteConfirm: 'Deletion Confirmation',
      ruleProductionOrderIdRequired: 'Please enter the production order ID',
      placeholderTerminateReason: 'Termination reason (optional)',
      placeholderActualWeightInput: 'Actual weighed weight in kg (required)',
      messageFetchListFailed: 'Failed to load flow card list',
      messageTerminatePrompt: 'Terminate flow card {no}? You may fill in a termination reason.',
      messageCompletePreparingPrompt:
        'Enter the actual weighed weight (kg) for finishing preparation of flow card {no}',
      messageInvalidWeight: 'Please enter a valid positive weight (up to two decimals)',
      messageConfirmAction: 'Perform "{action}" on flow card {no}?',
      messageOperationSuccess: 'Operation succeeded: {action}',
      messageOperationFailed: 'Operation failed: {action}',
      messageCreateSuccess: 'Flow card created successfully',
      messageCreateFailed: 'Failed to create flow card',
      messageDeleteConfirm: 'Delete flow card {no}?',
      messageDeleteFailed: 'Delete failed',
    },
  },
  labDip: {
    index: {
      pageTitle: 'Lab Dip Request Management',
      placeholderAllStatus: 'All statuses',
      buttonCreate: 'New Lab Dip Request',
      titleCreate: 'New Lab Dip Request',
      titleDetail: 'Lab Dip Request Detail',
      colRequestNo: 'Request No.',
      colCustomerColorNo: 'Customer Color No.',
      colCustomerColorName: 'Customer Color Name',
      colLightSource: 'Main Light Source',
      colSampleVersions: 'Versions',
      colRequiredDate: 'Required Date',
      labelCustomerId: 'Customer ID',
      labelLightSource: 'Main Color-Matching Light Source',
      labelFabricSpec: 'Greige Fabric Spec',
      placeholderFabricSpec: 'Yarn count / composition / structure, optional',
      labelDyeCategory: 'Dye Category',
      labelSampleVersions: 'Sample Versions',
      labelRemarks: 'Remarks',
      labelSampleType: 'Sample Type',
      labelSecondaryLightSource: 'Secondary Light Source',
      labelFabricComponent: 'Fiber Composition',
      placeholderRequired: 'Required',
      placeholderOptional: 'Optional',
      buttonConfirm: 'Confirm',
      buttonStartSampling: 'Start Sampling',
      buttonSubmitToCustomer: 'Submit to Customer',
      buttonApprove: 'Customer Approved',
      buttonReject: 'Reject & Redo',
      buttonRestart: 'Restart Sampling',
      buttonComplete: 'Complete Sampling',
      buttonConfirmDelete: 'Confirm Deletion',
      optionReactive: 'Reactive',
      optionDisperse: 'Disperse',
      optionAcid: 'Acid',
      optionVat: 'Vat',
      optionSulfur: 'Sulfur',
      optionDirect: 'Direct',
      statusPending: 'Pending Sampling',
      statusSampling: 'Sampling',
      statusSubmitted: 'Sent to Customer',
      statusApproved: 'Customer Confirmed',
      statusRejected: 'Customer Rejected',
      statusCompleted: 'Completed',
      titleCompleteToRecipe: 'Complete & File Recipe',
      titleActionConfirm: 'Operation Confirmation',
      titleDeleteConfirm: 'Deletion Confirmation',
      ruleLightSourceRequired: 'Please select the main color-matching light source',
      ruleRequiredDateRequired: 'Please select the required date',
      messageApprovePrompt: 'Enter the sample ID the customer confirmed OK (lab dip request {no})',
      placeholderSampleId: 'sample_id (required, positive integer)',
      messageInvalidSampleId: 'Please enter a valid positive integer sample ID',
      messageFetchListFailed: 'Failed to load lab dip request list',
      messageCompletePrompt: 'Enter the bulk production recipe ID to file (lab dip request {no})',
      placeholderProductionRecipeId: 'production_recipe_id (required, positive integer)',
      messageInvalidRecipeId: 'Please enter a valid positive integer recipe ID',
      messageConfirmAction: 'Perform "{action}" on lab dip request {no}?',
      messageOperationSuccess: 'Operation succeeded: {action}',
      messageOperationFailed: 'Operation failed: {action}',
      messageCreateSuccess: 'Lab dip request created successfully',
      messageCreateFailed: 'Failed to create lab dip request',
      messageDeleteConfirm: 'Delete lab dip request {no}?',
      messageDeleteFailed: 'Delete failed (only pending requests can be deleted)',
    },
  },
  bulkColorApproval: {
    index: {
      pageTitle: 'Bulk Color Approval',
      buttonCreate: 'New Bulk Color Request',
      titleCreate: 'New Bulk Color Request',
      buttonStatistics: 'Statistics',
      titleStatistics: 'Bulk Color Statistics',
      buttonConfirm: 'Confirm',
      colApprovalNo: 'Request No.',
      colOrderNo: 'Order No.',
      colColorNo: 'Color No.',
      colDyeLotNo: 'Dye Lot No.',
      colApplicant: 'Applicant',
      colFromStatus: 'Previous Status',
      colToStatus: 'New Status',
      colOperator: 'Operator',
      colReason: 'Reason',
      colCreatedAt: 'Time',
      buttonCut: 'Cut Sample',
      buttonSend: 'Send to Customer',
      buttonApprove: 'Approve Color',
      buttonRework: 'Rework',
      buttonReject: 'Reject',
      buttonDowngrade: 'Downgrade',
      buttonScrap: 'Scrap',
      titleDetail: 'Bulk Color Request Detail',
      titleReject: 'Bulk Color Rejection',
      titleDowngrade: 'Bulk Color Downgrade',
      titleScrap: 'Bulk Color Scrap',
      sectionHistory: 'Transfer History',
      labelSalesOrder: 'Sales Order',
      labelDyeBatch: 'Dye Batch',
      labelCustomer: 'Customer',
      labelBatchNo: 'Batch No.',
      labelRemarks: 'Remarks',
      placeholderSalesOrderId: 'Sales order ID (required)',
      placeholderDyeBatchId: 'Dye batch ID (required)',
      placeholderCustomerId: 'Customer ID (required)',
      placeholderOptional: 'Optional',
      statusDraft: 'Draft',
      statusPending: 'Pending Approval',
      statusCut: 'Sample Cut',
      statusSentToCustomer: 'Sent to Customer',
      statusCustomerApproved: 'Customer Approved',
      statusCustomerRejected: 'Customer Rejected',
      statusApproved: 'Approved',
      statusRejected: 'Rejected',
      ...
      statusScrapped: 'Scrapped',
      statusCancelled: 'Cancelled',
      messageFetchListFailed: 'Failed to load bulk color list: {msg}',
      messageRequiredFields: 'Sales order, dye batch and customer ID are all required',
      messageCreateSuccess: 'Bulk color request created',
      messageCreateFailed: 'Create failed: {msg}',
      messageActionSuccess: '{action} succeeded',
      messageActionFailed: '{action} failed: {msg}',
      messageRejectPrompt: 'Please enter the rejection reason',
      messageDowngradePrompt: 'Please enter the downgrade reason',
      messageScrapPrompt: 'Please enter the scrap reason',
      messageDowngradeReasonRequired: 'Downgrade reason is required',
      messageScrapReasonRequired: 'Scrap reason is required',
      messageFetchStatsFailed: 'Failed to get statistics',
    },
  },
  fiveDimension: {
    index: {
      ...
      titleAssistRecords: 'Related Assist Records',
      ariaAssistTable: 'Assist records table',
      colRecordNo: 'Record No.',
  ...
  email: {
    index: {
      ...
      titleViewTemplate: 'Template Detail',
      ariaSendDialog: 'Send Email Dialog',
      ariaSendForm: 'Send Email Form',
      placeholderSendTo: 'Recipient emails, separated by commas',
      ruleRecipientRequired: 'Please enter recipient',
      messageSendSuccess: 'Sent successfully',
      messageSendFailed: 'Failed to send',
      messageFetchTemplateFailed: 'Failed to fetch template detail',
    },
  },
  greigeFabrics: {
    index: {
  ...
  inventoryAdjustment: {
    ...
    formDialogTab: {
      ...
      buttonCancel: 'Cancel',
      buttonSave: 'Save',
      dividerServerItems: 'Saved Items (Server)',
      colStockId: 'Stock ID',
      colQuantityBefore: 'Qty Before',
      colQuantity: 'Qty',
      colQuantityAfter: 'Qty After',
      colOperation: 'Action',
      buttonSaveItem: 'Save',
      buttonDeleteItem: 'Delete',
      messageDeleteItemConfirm: 'Delete this adjustment item?',
      messageSuccess: 'Operation successful',
      messageFailed: 'Operation failed',
  ...
  inventoryCount: {
    ...
    listTab: {
      ...
      messageApproveConfirm:
        'Approve this count order? Stock will be adjusted by the variance after approval.',
      titleApproveConfirm: 'Confirm Approval',
      messageRejectConfirm: 'Reject this count order? It will return to pending status.',
      titleRejectConfirm: 'Confirm Rejection',
      messageDeleteConfirm: 'Delete this count order?',
      titleDeleteConfirm: 'Confirm Deletion',
      messageSuccess: 'Operation successful',
      messageFailure: 'Operation failed',
    ...
    detailDialogTab: {
      ...
      buttonRecord: 'Submit Actual Qty',
      colStockId: 'Stock ID',
      colProductId: 'Product ID',
      colQuantityBefore: 'Book Qty',
      colQuantityActual: 'Actual Qty',
      colQuantityDiff: 'Variance',
      colOperation: 'Action',
      buttonSaveItem: 'Save',
      buttonDeleteItem: 'Delete',
      messageDeleteItemConfirm: 'Delete this count item?',
      statusLabel: {
        in_progress: 'In Progress',
        pending: 'Pending',
        in_review: 'In Review',
  ...
  materialShortage: {
    ...
    checkResult: 'Shortage check finished, {count} materials are short',
    confirmStatusChange: 'Update the shortage alert status of "{material}" to "{status}"?',
    level: {
      critical: 'Critical',
      severe: 'Severe',
      warning: 'Warning',
    ...
    status: {
      ...
      purchaseRequest: 'Purchase Requested',
      purchaseOrder: 'Purchased',
      received: 'Received',
      resolved: 'Resolved',
    },
    priority: {
    ...
    replenishment: {
      ...
      refresh: 'Recalculate',
      ariaLabel: 'Shortage Replenishment Suggestion List',
      suggestedQuantity: 'Suggested Qty',
      unit: 'Unit',
      priority: 'Priority',
      empty: 'No shortage, no suggestion',
    },
    stat: {
      materialsChecked: 'Materials Checked',
      shortageCount: 'Short Materials',
      criticalShortage: 'Critical Shortage',
      affectedOrders: 'Affected Orders',
    },
    table: {
      ariaLabel: 'Material Shortage Alert List',
      levelPlaceholder: 'Shortage Level',
      statusPlaceholder: 'Alert Status',
      search: 'Search',
      ...
      statusUnsaved: 'Not Persisted',
      statusAriaLabel: 'Update shortage alert status',
  ...
  mrp: {
    history: {
      ...
      exportResult: 'Export',
      viewSupplyDetail: 'Supply Detail',
      supplyDetailTitle: 'Material Supply Details',
      ...
      filterAriaLabel: 'MRP History Filters',
      filterCalculationNoPlaceholder: 'Enter calculation no.',
      filterProductPlaceholder: 'All products',
      filterStatusPlaceholder: 'All statuses',
      search: 'Search',
      reset: 'Reset',
      plannedOrderQuantity: 'Planned Order Qty',
      plannedOrderDate: 'Planned Order Date',
      source: 'Source',
      remarks: 'Remarks',
      updatedAt: 'Updated At',
      onHandQuantity: 'On Hand',
      shortageQuantity: 'Shortage Qty',
      stockDivider: 'Stock Breakdown',
      cancelConfirmMessage: 'Cancel calculation {no}?',
    },
    calc: {
