...
export default {
  ...
  sales: {
    ...
    orderForm: {
      ...
      tolerance: 'Tolerance %',
      tolerancePlaceholder: 'Empty = fabric 5% / piece 0% default',
    },
    orderDetail: {
  ...
  message: {
    ...
    skuMappingNotFound: 'No supplier mapping for this product color, please maintain first',
    skuMappingResolveFailed: 'SKU mapping resolve failed, please retry later',
    skuMappingRequired: 'Some lines have no SKU mapping; cannot create PO without mapping',
    skuMappingFormRequired: 'Please select product, supplier and supplier product',
    supplierProductRequired: 'Please complete the required supplier product fields',
    supplierProductColorRequired: 'Please complete the required color fields',
    importPartialFail: 'Import completed with some failures',
  },
  aiExtend: {
    qualityPrediction: {
  ...
  budget: {
    ...
    plan: {
      ...
      dialog: {
        createTitle: 'Create Budget Plan',
        formAriaLabel: 'Budget plan form',
        planNo: 'Plan No',
        planNoPlaceholder: 'Optional, generated by server if empty',
        planName: 'Plan Name',
        budgetYear: 'Budget Year',
        budgetType: 'Budget Type',
        budgetTypePlaceholder: 'e.g. Annual Budget',
        departmentId: 'Department ID',
        totalAmount: 'Total Amount',
        remark: 'Remark',
        cancel: 'Cancel',
      ...
      validation: {
        ...
        budgetYearRequired: 'Please enter budget year',
        departmentRequired: 'Please enter department ID',
      },
      message: {
        loadFailed: 'Failed to load budget plan list',
        created: 'Budget plan created',
        approveConfirm: 'Approve plan "{name}"?',
        rejectConfirm: 'Reject plan "{name}"?',
    ...
    item: {
      ...
      dialog: {
        ...
        createTitle: 'Create Budget Item',
        ariaLabel: 'Budget item edit dialog',
        formAriaLabel: 'Budget item form',
        planId: 'Plan',
        itemName: 'Item Name',
        itemCode: 'Item Code',
        itemCodePlaceholder: 'Optional, auto-generated if empty',
        itemType: 'Item Type',
        plannedAmount: 'Planned Amount',
        remark: 'Remark',
        cancel: 'Cancel',
      ...
      validation: {
        ...
        plannedAmountRequired: 'Please enter planned amount',
      },
      period: {
        section: 'Period Breakdown (monthly/quarterly)',
        add: 'Add Period',
        type: 'Type',
        month: 'Monthly',
        quarter: 'Quarterly',
        ...
        remove: 'Remove',
        total: 'Period Total',
        empty: 'No period entered; the server will generate one yearly total row on save',
        mismatch:
          'Period total {sum} differs from planned amount {planned}; server validation is authoritative',
      },
      message: {
        loadFailed: 'Failed to load budget items',
        created: 'Budget item created',
        updated: 'Budget item updated',
        deleteConfirm: 'Delete item "{name}"?',
      },
    },
  },
  businessTrace: {
  ...
  product: {
    ...
    productFormDialogTab: {
      ...
      labelMetersPerPiece: 'Meters per Piece',
      tipMetersPerPiece:
        'Meters per piece, used for the piece↔meter conversion view; not counted in inventory',
      labelMetersPerRoll: 'Meters per Roll',
      tipMetersPerRoll:
        'Meters per roll, used for the roll↔meter conversion view; not counted in inventory',
      ...
      validateUnitRequired: 'Please select unit',
      messageCreateSuccess: 'Created successfully',
  ...
  apModule: {
    ...
    payment: {
      ...
      requestSelect: 'Payment Request',
      requestSelectPlaceholder: 'Please select an approved payment request',
      requestSelectEmpty: 'No approved payment request available',
      requestSelectRequired: 'Please select a payment request',
      requestFetchFailed: 'Failed to fetch approvable payment requests',
      supplierFetchFailed: 'Failed to fetch supplier list',
      transactionNoPrompt: 'A transaction number is required before confirming the payment',
      transactionNoTitle: 'Enter Transaction Number',
      transactionNoPlaceholder: 'Please enter transaction number',
      transactionNoRequired: 'Transaction number is required',
      printFailed: 'Failed to print payment',
    },
    reconciliation: {
  ...
  quotations: {
    ...
    itemEditor: {
      ...
      unitPiece: 'Piece',
      unitTon: 'Ton',
      unitFollowProductPlaceholder: 'Auto-filled from product',
      productUnitMissing: 'Please configure a trading unit in the product master data first',
      colQuantity: 'Quantity',
      colUnitPrice: 'Unit Price',
    ...
    create: {
      ...
      validateItemsInvalid:
        'Each item must have a product, a unit derived from the product, and quantity > 0',
  ...
  fabric: {
    ...
    greigeFormDialog: {
      ...
      fabricTypeRequired: 'Please enter fabric type',
      placeholderFabricType: 'e.g. Cotton, Polyester',
  ...
  budgets: {
    form: {
      planId: 'Budget Plan',
      planIdPlaceholder: 'Please select a budget plan',
    },
  },
  salesPrice: {
    index: {
  ...
  financeReport: {
    ...
    reportListTab: {
      ...
      labelPeriodBalance: 'Period Balance',
      labelTotalInitialCredit: 'Total Opening Credit',
      labelTotalInitialDebit: 'Total Opening Debit',
      labelDimensionValue: 'Dimension Value',
      labelDimensionType: 'Dimension Type',
      ...
      labelEndingCash: 'Ending Cash',
      labelBeginningCash: 'Beginning Cash',
      labelNetChangeInCash: 'Net Change in Cash',
      labelNetCashFinancing: 'Net Cash from Financing Activities',
      labelNetCashInvesting: 'Net Cash from Investing Activities',
      labelNetCashOperations: 'Net Cash from Operating Activities',
      labelNetIncome: 'Net Income',
      labelOtherExpenses: 'Other Expenses',
      labelOtherIncome: 'Other Income',
      labelOperatingIncome: 'Operating Income',
      labelTotalOperatingExpenses: 'Total Operating Expenses',
      labelGrossProfit: 'Gross Profit',
      labelCostOfGoodsSold: 'Cost of Goods Sold',
      labelTotalRevenue: 'Total Revenue',
      labelTotalEquity: 'Total Equity',
      labelTotalLiabilities: 'Total Liabilities',
      labelTotalAssets: 'Total Assets',
      labelPeriodRange: 'Period',
      labelReportDate: 'Report Date',
      colBusinessType: 'Business Type',
      colBusinessNo: 'Business No',
      colBusinessDate: 'Business Date',
      colEndingCredit: 'Ending Credit',
      colEndingDebit: 'Ending Debit',
      colPeriodCredit: 'Period Credit',
      colPeriodDebit: 'Period Debit',
      colInitialCredit: 'Opening Credit',
      colInitialDebit: 'Opening Debit',
      colLineNo: 'Line No',
      colSubjectName: 'Subject Name',
      colSubjectCode: 'Subject Code',
      colDescription: 'Description',
      sectionFinancingActivities: 'Financing Activities',
      sectionInvestingActivities: 'Investing Activities',
      sectionOperatingActivities: 'Operating Activities',
  ...
  skuMapping: {
    pageAria: 'SKU Mapping Management',
    title: 'SKU Mapping',
    create: 'New Mapping',
    import: 'Batch Import',
    importTitle: 'Batch Import SKU Mappings',
    editTitle: 'Edit SKU Mapping',
    createTitle: 'New SKU Mapping',
    deleteConfirm: 'Confirm delete this mapping record?',
    uploadHint: 'Drag or click to upload Excel (.xlsx/.xls/.csv)',
    importing: 'Importing...',
    importSummary: '{success} succeeded, {fail} failed',
    errorRow: 'Row',
    errorMessage: 'Error',
    filter: {
      product: 'Our Product',
    ...
    columns: {
      productCode: 'Product Code',
      ourColorNo: 'Our Color No',
      supplier: 'Supplier',
      supplierProductCode: 'Supplier Product Code',
      supplierColorNo: 'Supplier Color No',
      price: 'Agreed Price',
      isPrimary: 'Primary',
      isEnabled: 'Enabled',
    },
    ...
    placeholders: {
      product: 'Select product',
      ourColor: 'Search color',
      ourColorNo: 'Auto-filled',
      supplier: 'Select supplier',
      supplierProductId: 'Supplier product internal ID',
      supplierFirst: 'Select a supplier first',
      supplierProduct: 'Search supplier product',
      supplierProductCode: 'Supplier product code',
      supplierProductFirst: 'Select a supplier product first',
      supplierColor: 'Search supplier color',
      supplierColorNo: 'Supplier color no',
      supplierPrice: 'Unit price',
      minOrderQuantity: 'e.g. 100',
      leadTime: 'Days',
    },
  },
  supplierProduct: {
    pageAria: 'Supplier Product Management',
    title: 'Supplier Products',
    create: 'New Product',
    editTitle: 'Edit Supplier Product',
    createTitle: 'New Supplier Product',
    filter: {
      supplier: 'Supplier',
      keyword: 'Keyword',
    },
    ...
    formPlaceholders: {
      supplier: 'Select supplier',
      productCode: 'Supplier side product code',
      productName: 'Supplier side product name',
