                    ...
                    <table class="data-table w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="py-2 px-4 border-b text-left">{"电话"}</th>
                                    ...
                                    html! {
                                        for departments.iter().map(|dept| html! {
                                            <tr key={dept.id}>
                                                ...
                                                <td class="py-2 px-4 border-b text-left">{ &dept.code }</td>
                                                <td class="py-2 px-4 border-b text-left">{ &dept.name }</td>
                                                <td class="py-2 px-4 border-b text-left">{ dept.manager.clone().unwrap_or_default() }</td>
                                                <td class="py-2 px-4 border-b text-left">{ dept.phone.clone().unwrap_or_default() }</td>
