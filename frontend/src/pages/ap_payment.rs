...
impl Component for ApPaymentPage {
    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        ...
        let on_method_change = ctx.link().batch_callback(|e: Event| {
            let target = e.target()?.dyn_into::<web_sys::HtmlSelectElement>().ok()?;
            Some(Msg::SetFilterMethod(target.value()))
        });
                    ...
                    <div class="modal-content" style="width: 800px; max-width: 90vw;">
                        ...
                        <div class="modal-body">
                            <div class="detail-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                                ...
                                <div class="detail-item">
                                    <span class="detail-label" style="font-weight: bold; color: #666;">{"Request Id: "}</span>
                                    <span class="detail-value">{item.request_id.to_string()}</span>
                                </div>
                                <div class="detail-item">
                                    <span class="detail-label" style="font-weight: bold; color: #666;">{"Request No: "}</span>
                                    <span class="detail-value">{item.request_no.as_deref().unwrap_or("-")}</span>
                                </div>
                                <div class="detail-item">
                                ...
                                <div class="detail-item">
                                    <span class="detail-label" style="font-weight: bold; color: #666;">{"Payment Amount: "}</span>
                                    <span class="detail-value">{&item.payment_amount}</span>
                                </div>
                                <div class="detail-item">
                                    <span class="detail-label" style="font-weight: bold; color: #666;">{"Payment Status: "}</span>
                                    <span class="detail-value">{&item.payment_status}</span>
                                </div>
                                <div class="detail-item">
                                ...
                                <div class="detail-item">
                                    <span class="detail-label" style="font-weight: bold; color: #666;">{"Payment Amount Foreign: "}</span>
                                    <span class="detail-value">{item.payment_amount_foreign.as_deref().unwrap_or("-")}</span>
                                </div>
                                <div class="detail-item">
                                ...
                                <div class="detail-item">
                                    <span class="detail-label" style="font-weight: bold; color: #666;">{"Confirmer Name: "}</span>
                                    <span class="detail-value">{item.confirmer_name.as_deref().unwrap_or("-")}</span>
                                </div>
                                <div class="detail-item">
