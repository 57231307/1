                        ...
                        <div class="modal-body">
                            <div class="detail-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                                ...
                                <div class="detail-item">
                                    ...
                                    <span class="detail-value">{&item.customer_name}</span>
                                </div>
                                <div class="detail-item">
                                ...
                                <div class="detail-item">
                                    ...
                                    <span class="detail-value">{&item.tax_amount}</span>
                                </div>
                                <div class="detail-item">
                                ...
                                <div class="detail-item">
                                    ...
                                    <span class="detail-value">{item.invoice_date.as_deref().unwrap_or("-")}</span>
                                </div>
                                <div class="detail-item">
                                ...
                                <div class="detail-item">
                                    <span class="detail-label" style="font-weight: bold; color: #666;">{"Paid Date: "}</span>
                                    <span class="detail-value">{item.paid_date.as_deref().unwrap_or("-")}</span>
                                </div>
                                <div class="detail-item">
