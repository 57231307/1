...
impl SupplierEvaluationService {
    pub async fn list_evaluations(
        ...
        ApiService::get(&format!("/api/v1/erp/supplier-evaluation/evaluations?{}", query)).await
    }

    pub async fn get_evaluation(id: i32) -> Result<SupplierEvaluation, String> {
        ApiService::get(&format!("/api/v1/erp/supplier-evaluation/evaluations/{}", id)).await
    }

    pub async fn create_evaluation(req: CreateEvaluationRequest) -> Result<SupplierEvaluation, String> {
        let payload = serde_json::to_value(&req).map_err(|e| e.to_string())?;
        ApiService::post("/api/v1/erp/supplier-evaluation/evaluations", &payload).await
    }

    pub async fn update_evaluation(id: i32, req: UpdateEvaluationRequest) -> Result<SupplierEvaluation, String> {
        let payload = serde_json::to_value(&req).map_err(|e| e.to_string())?;
        ApiService::put(&format!("/api/v1/erp/supplier-evaluation/evaluations/{}", id), &payload).await
    }

    pub async fn delete_evaluation(id: i32) -> Result<(), String> {
        ApiService::delete(&format!("/api/v1/erp/supplier-evaluation/evaluations/{}", id)).await
    }

    pub async fn calculate_score(supplier_id: i32, period: &str) -> Result<SupplierEvaluation, String> {
        ApiService::post(
            &format!("/api/v1/erp/supplier-evaluation/suppliers/{}/calculate?period={}", supplier_id, period),
            &serde_json::json!({})
        ).await
    }
    ...
    pub async fn get_rankings(
        ...
        ApiService::get(&format!("/api/v1/erp/supplier-evaluation/rankings{}", query)).await
    }
    ...
    pub async fn list_indicators(
        ...
        ApiService::get(&format!("/api/v1/erp/supplier-evaluation/indicators?{}", query)).await
    }

    pub async fn get_indicator(id: i32) -> Result<SupplierIndicator, String> {
        ApiService::get(&format!("/api/v1/erp/supplier-evaluation/indicators/{}", id)).await
    }

    pub async fn create_indicator(req: CreateIndicatorRequest) -> Result<SupplierIndicator, String> {
        let payload = serde_json::to_value(&req).map_err(|e| e.to_string())?;
        ApiService::post("/api/v1/erp/supplier-evaluation/indicators", &payload).await
    }

    pub async fn update_indicator(id: i32, req: UpdateIndicatorRequest) -> Result<SupplierIndicator, String> {
        let payload = serde_json::to_value(&req).map_err(|e| e.to_string())?;
        ApiService::put(&format!("/api/v1/erp/supplier-evaluation/indicators/{}", id), &payload).await
    }

    pub async fn delete_indicator(id: i32) -> Result<(), String> {
        ApiService::delete(&format!("/api/v1/erp/supplier-evaluation/indicators/{}", id)).await
    }
}
