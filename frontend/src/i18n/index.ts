/* vue-i18n 入口配置 - Bingxi Management Platform (P4-4) */
import { createI18n } from 'vue-i18n';
import zhCN from '../locales/zh-CN';
import enUS from '../locales/en-US';

// i18n 接入已完成（P1-24 前端架构批次），资源文件 zh-CN.ts 11647 行 / en-US.ts 11662 行，
// key 命名遵循 {module}.{field} 模式。已在 main.ts 通过 app.use(i18n) 挂载，
// globalInjection: true 已开启，模板内可直接使用 $t()，
// <script setup> 内通过 useI18n({ useScope: 'global' }) 取 t。
