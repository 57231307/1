...
<template>
  <el-dialog
    :model-value="visible"
    :title="
      t('bpm.definitions.versionDialog.title', { name: definition ? definition.process_name : '' })
    "
  ...
  >
    ...
    <el-table
      ...
      :data="data"
      border
      :aria-label="$t('bpm.definitions.versionDialog.tableAriaLabel')"
    >
      <el-table-column
        prop="version"
        :label="$t('bpm.definitions.versionDialog.version')"
        width="100"
        align="center"
      />
      <el-table-column
        prop="status"
        :label="$t('bpm.definitions.versionDialog.status')"
        width="100"
        align="center"
      >
      ...
      <el-table-column
        prop="change_log"
        :label="$t('bpm.definitions.versionDialog.changeLog')"
        min-width="180"
        show-overflow-tooltip
      />
      <el-table-column
        prop="created_at"
        :label="$t('bpm.definitions.versionDialog.createdAt')"
        width="160"
      />
      <el-table-column
        prop="created_by"
        :label="$t('bpm.definitions.versionDialog.createdBy')"
        width="100"
      />
      <el-table-column
        :label="$t('bpm.definitions.versionDialog.operation')"
        width="120"
        fixed="right"
      >
        <template #default="{ row }">
