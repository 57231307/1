  ...
  <div class="bpm-approval-page">
    ...
    <el-tabs v-model="activeTab" @tab-change="handleTabChange">
      <el-tab-pane label="待办任务" name="pending">
        <el-card shadow="hover" class="table-card">
          <el-table v-loading="pendingLoading" :data="pendingTasks" stripe>
      ...
      <el-tab-pane label="已办任务" name="completed">
        <el-card shadow="hover" class="table-card">
          <el-table v-loading="completedLoading" :data="completedTasks" stripe>
    ...
    <el-dialog v-model="transferDialogVisible" title="转交任务" width="500px" destroy-on-close>
      ...
      <template #footer>
        ...
        <el-button type="primary" :loading="submitLoading" @click="confirmTransfer">确定</el-button>
      </template>
    </el-dialog>
