...
const loadDepartments = async () => {
  ...
  try {
    ...
    // 后端 list 返回 PaginatedResponse { items, total }（getDepartmentList 已按真实信封声明）
    departmentList.value = listRes.data.items;
    // 后端 get_department_tree 返回 Vec<DepartmentTreeNode>（data 为裸数组）
