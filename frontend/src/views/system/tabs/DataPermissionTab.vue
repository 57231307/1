...
<template>
  <div class="data-permission-tab">
    ...
    <el-card shadow="hover">
      <el-table
        v-loading="dataPermLoading"
        :data="dataPermissionList"
        stripe
        :aria-label="t('system.dataPermission.aria.list')"
      >
        <el-table-column
          prop="role_name"
          :label="t('system.dataPermission.column.role')"
          width="120"
        />
        <el-table-column
          prop="scope_type"
          :label="t('system.dataPermission.column.scopeType')"
          width="120"
        />
        <el-table-column
          prop="scope_value"
          :label="t('system.dataPermission.column.scopeValue')"
          min-width="200"
        />
        <el-table-column
          prop="created_at"
          :label="t('system.dataPermission.column.createdAt')"
          width="160"
        />
      </el-table>
    </el-card>
