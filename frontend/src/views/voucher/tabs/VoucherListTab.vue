<!--
  VoucherListTab.vue - 凭证列表 Tab
  来源：原 voucher/index.vue 主体内容
  ...
  <div class="voucher-list-tab">
    ...
    >
      ...
      <ElTableColumn label="操作" width="300" align="center">
        <template #default="scope">
          <ElButton size="small" @click="openViewDialog(scope.row as VoucherEntity)">
            <View />
          </ElButton>
          <ElButton
            ...
            size="small"
            type="primary"
            @click="openEditDialog(scope.row as VoucherEntity)"
          >
            <Edit />
          </ElButton>
          <ElButton
            ...
            size="small"
            type="warning"
            @click="handleApprove(scope.row as VoucherEntity)"
          >
            <Check /> 审核
          </ElButton>
          <ElButton
            ...
            size="small"
            type="success"
            @click="handlePost(scope.row as VoucherEntity)"
          >
            <Check /> 记账
          </ElButton>
          <ElButton
            ...
            size="small"
            type="info"
            @click="handleUnpost(scope.row as VoucherEntity)"
          >
            <Refresh /> 反记账
          </ElButton>
          <ElButton
            ...
            size="small"
            type="danger"
            @click="handleDelete(scope.row as VoucherEntity)"
          >
            <Delete />
          </ElButton>
        </template>
...
const loadData = async () => {
  ...
  try {
    ...
    if (Array.isArray(d)) {
      ...
      tableData.value = listData.list || listData.items || []
...
const loadAccountSubjects = async () => {
  try {
    ...
    const flattenOptions = (): { label: string; value: number }[] => {
