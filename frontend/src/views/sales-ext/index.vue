<!--
  sales-ext/index.vue - 销售扩展主入口（容器组件）
  ----------------------------------------------------------------
  拆分说明（2026-06-15 B3-1）：
  原 1148 行"上帝组件"已拆分为以下 3 个独立 Tab 子组件，
  位于 views/sales-ext/tabs/ 目录：

  | Tab       | 子组件                              |
  | --------- | ----------------------------------- |
  | 销售合同  | tabs/ContractTab.vue                |
  | 销售价格  | tabs/PriceTab.vue                   |
  | 销售退货  | tabs/ReturnTab.vue                  |
