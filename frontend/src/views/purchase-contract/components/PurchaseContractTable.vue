...
<template>
  <el-card shadow="hover" class="table-card">
    <el-table
      ...
      border
      stripe
      :aria-label="t('purchaseContract.table.listAria')"
    >
      <el-table-column
        type="index"
        :label="t('purchaseContract.table.colIndex')"
        width="60"
        align="center"
      />
      <el-table-column
        prop="contract_no"
        :label="t('purchaseContract.table.colContractNo')"
        width="150"
      ...
      <el-table-column
        prop="supplier_name"
        :label="t('purchaseContract.table.colSupplier')"
        width="150"
        show-overflow-tooltip
      />
      <el-table-column
        prop="total_amount"
        :label="t('purchaseContract.table.colTotalAmount')"
        width="120"
        align="right"
      >
      ...
      <el-table-column
        prop="signed_date"
        :label="t('purchaseContract.table.colSignedDate')"
        width="120"
        align="center"
      />
      <el-table-column
        prop="effective_date"
        :label="t('purchaseContract.table.colEffectiveDate')"
        width="120"
        align="center"
      />
      <el-table-column
        prop="expiry_date"
        :label="t('purchaseContract.table.colExpiryDate')"
        width="120"
        align="center"
      />
      <el-table-column
        prop="status"
        :label="t('purchaseContract.table.colStatus')"
        width="100"
        align="center"
      >
        <template #default="{ row }">
      ...
      <el-table-column
        :label="t('purchaseContract.table.colOperation')"
        width="250"
        align="center"
        fixed="right"
      >
        <template #default="{ row }">
          <el-button
            ...
            link
            size="small"
            @click="emit('view', row as PurchaseContract)"
