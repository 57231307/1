...
<template>
  ...
  >
    <el-table
      ...
      border
      stripe
      :aria-label="t('purchasePrice.history.ariaLabel.table')"
    >
      <el-table-column
        prop="price"
        :label="t('purchasePrice.history.column.price')"
        width="120"
        align="right"
      >
      ...
      <el-table-column
        prop="effective_date"
        :label="t('purchasePrice.history.column.effectiveDate')"
        width="120"
        align="center"
      />
      <el-table-column
        prop="expiry_date"
        :label="t('purchasePrice.history.column.expiryDate')"
        width="120"
        align="center"
      />
      <el-table-column
        prop="status"
        :label="t('purchasePrice.history.column.status')"
        width="100"
        align="center"
      >
        <template #default="{ row }">
      ...
      <el-table-column
        prop="created_at"
        :label="t('purchasePrice.history.column.createdAt')"
        width="180"
        align="center"
      />
    </el-table>
