...
<template>
  ...
  >
    <el-form ref="formRef" :model="formData" label-width="80px" :aria-label="$t('inventoryTransfer.approveTransfer.formAriaLabel')">
      ...
      <el-form-item :label="$t('inventoryTransfer.approveTransfer.approvalComment')" prop="approval_comment">
        <el-input
    ...
    <template #footer>
      <el-button @click="emit('update:modelValue', false)">{{ $t('inventoryTransfer.approveTransfer.cancel') }}</el-button>
      <el-button type="warning" :loading="submitLoading" @click="handleReject">{{ $t('inventoryTransfer.approveTransfer.reject') }}</el-button>
      <el-button type="primary" :loading="submitLoading" @click="handlePass">{{ $t('inventoryTransfer.approveTransfer.pass') }}</el-button>
    </template>
  </el-dialog>
</template>
