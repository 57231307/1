...
<template>
  ...
  >
    <el-form :model="localForm" label-width="80px" :aria-label="t('logistics.statusDialog.aria.form')">
      ...
      <el-form-item :label="t('logistics.statusDialog.label.newStatus')">
        <el-select v-model="localForm.newStatus" :placeholder="t('logistics.statusDialog.placeholder.newStatus')">
          <el-option
    ...
    <template #footer>
      <el-button @click="emit('update:visible', false)">{{ t('logistics.statusDialog.button.cancel') }}</el-button>
      <el-button type="primary" @click="emit('submit')">{{ t('logistics.statusDialog.button.confirm') }}</el-button>
    </template>
  </el-dialog>
</template>
