...
<template>
  <el-dialog
    ...
    width="600px"
    :aria-label="
      isEdit ? t('logistics.form.aria.editDialog') : t('logistics.form.aria.createDialog')
    "
  ...
  >
    <el-form
      ...
      :rules="rules"
      label-width="100px"
      :aria-label="t('logistics.form.aria.form')"
    >
      <el-form-item :label="t('logistics.form.label.relatedOrder')" prop="order_id">
        <el-select
          v-model="localForm.order_id"
          :placeholder="t('logistics.form.placeholder.relatedOrder')"
          filterable
        >
          <el-option
      ...
      <el-form-item :label="t('logistics.form.label.trackingNumber')" prop="tracking_number">
        <el-input
          ...
          :placeholder="t('logistics.form.placeholder.trackingNumber')"
        />
      </el-form-item>
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="t('logistics.form.label.driverName')">
            <el-input
              v-model="localForm.driver_name"
              :placeholder="t('logistics.form.placeholder.driverName')"
            />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="t('logistics.form.label.driverPhone')">
            <el-input
              v-model="localForm.driver_phone"
              :placeholder="t('logistics.form.placeholder.driverPhone')"
            />
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-form-item :label="t('logistics.form.label.notes')">
        <el-input
          ...
          type="textarea"
          :rows="3"
          :placeholder="t('logistics.form.placeholder.notes')"
        />
      </el-form-item>
    </el-form>
    <template #footer>
      <el-button @click="emit('update:visible', false)">{{
        t('logistics.form.button.cancel')
      }}</el-button>
      <el-button type="primary" :loading="loading" @click="onSubmit">{{
        t('logistics.form.button.confirm')
      }}</el-button>
    </template>
  </el-dialog>
</template>
