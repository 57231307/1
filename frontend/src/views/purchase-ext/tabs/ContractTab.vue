  ...
  <div class="contract-tab">
    ...
    <el-card shadow="hover">
      <el-table
        ...
        stripe
        :aria-label="t('purchaseExt.contractTab.listAria')"
      >
        <el-table-column
          prop="contract_no"
          :label="t('purchaseExt.contractTab.colContractNo')"
          width="140"
        />
        <el-table-column
          prop="supplier_name"
          :label="t('purchaseExt.contractTab.colSupplier')"
          min-width="150"
        />
        <el-table-column
          prop="contract_date"
        ...
        <el-table-column
          prop="total_amount"
          :label="t('purchaseExt.contractTab.colTotalAmount')"
          width="120"
          align="right"
        >
        ...
        <el-table-column
          prop="status"
          :label="t('purchaseExt.contractTab.colStatus')"
          width="100"
          align="center"
        >
          <template #default="{ row }">
        ...
        <el-table-column
          ...
          :label="t('purchaseExt.contractTab.colCreator')"
          width="100"
        />
        <el-table-column
          :label="t('purchaseExt.contractTab.colOperation')"
          width="240"
          fixed="right"
        >
          <template #default="{ row }">
            <el-button
              size="small"
              link
              @click="viewContract(row as unknown as PurchaseContract)"
    ...
    <el-dialog
      ...
      :title="
        contractForm.id
          ? t('purchaseExt.contractTab.editTitle')
          : t('purchaseExt.contractTab.createTitle')
      "
      width="800px"
    ...
    >
      ...
      >
          ...
          <el-col :span="12">
            <el-form-item :label="t('purchaseExt.contractTab.supplier')" prop="supplier_name">
              <el-input
                ...
                :placeholder="t('purchaseExt.contractTab.supplierPlaceholder')"
              />
            </el-form-item>
          </el-col>
        </el-row>
          ...
          <el-col :span="12">
            <el-form-item :label="t('purchaseExt.contractTab.currency')" prop="currency">
              <el-select
                ...
                :placeholder="t('purchaseExt.contractTab.currencyPlaceholder')"
                style="width: 100%"
              >
        ...
        <el-table
          ...
          border
          style="width: 100%"
          :aria-label="t('purchaseExt.contractTab.detailEditAria')"
        >
          <el-table-column
            prop="product_name"
            :label="t('purchaseExt.contractTab.colProductName')"
            min-width="150"
          >
            <template #default="{ row }">
              <el-input
                v-model="row.product_name"
                :placeholder="t('purchaseExt.contractTab.productNamePlaceholder')"
              />
            </template>
          </el-table-column>
          <el-table-column
            prop="product_code"
            :label="t('purchaseExt.contractTab.colProductCode')"
            width="120"
          >
            <template #default="{ row }">
              <el-input
                v-model="row.product_code"
                :placeholder="t('purchaseExt.contractTab.productCodePlaceholder')"
              />
            </template>
          </el-table-column>
          <el-table-column
            prop="quantity"
            :label="t('purchaseExt.contractTab.colQuantity')"
            width="100"
          >
            <template #default="{ row }">
          ...
          <el-table-column prop="unit" :label="t('purchaseExt.contractTab.colUnit')" width="80">
            <template #default="{ row }">
              <el-input
                v-model="row.unit"
                :placeholder="t('purchaseExt.contractTab.unitPlaceholder')"
              />
            </template>
          </el-table-column>
          ...
          <el-table-column
            prop="amount"
            :label="t('purchaseExt.contractTab.colAmount')"
            width="100"
          >
            <template #default="{ row }">
    ...
    <el-dialog
      ...
      :title="t('purchaseExt.contractTab.viewTitle')"
      width="800px"
      :aria-label="t('purchaseExt.contractTab.viewDialogAria')"
    >
      ...
      <el-table
        ...
        stripe
        :aria-label="t('purchaseExt.contractTab.viewDetailAria')"
      >
        <el-table-column
          prop="product_name"
          :label="t('purchaseExt.contractTab.colProductName')"
        ...
        <el-table-column
          prop="price"
          :label="t('purchaseExt.contractTab.colPrice')"
          width="100"
          align="right"
        >
          <template #default="{ row }">
        ...
        <el-table-column
          prop="remark"
          :label="t('purchaseExt.contractTab.colRemark')"
          min-width="120"
        />
      </el-table>
...
const contractRules: FormRules = {
  contract_no: [
    { required: true, message: t('purchaseExt.contractTab.ruleContractNo'), trigger: 'blur' },
  ],
  supplier_name: [
    { required: true, message: t('purchaseExt.contractTab.ruleSupplierName'), trigger: 'blur' },
  ],
  contract_date: [
    { required: true, message: t('purchaseExt.contractTab.ruleContractDate'), trigger: 'change' },
  ],
  total_amount: [
    { required: true, message: t('purchaseExt.contractTab.ruleTotalAmount'), trigger: 'blur' },
  ],
};
...
const openContractDialog = async (row?: PurchaseContract) => {
  if (row) {
    ...
    contractForm.contract_no = await generateUniqueDocNo('PC', 'purchase_contract');
  }
...
const approveContract = async (row: PurchaseContract) => {
  try {
    await ElMessageBox.confirm(
      t('purchaseExt.contractTab.approveConfirm'),
