...
<template>
  <el-card shadow="hover">
    <el-table
      ...
      :data="tasks"
      stripe
      :aria-label="t('systemUpdate.taskTab.tableAriaLabel')"
    >
      <el-table-column
        prop="task_code"
        :label="t('systemUpdate.taskTab.columnTaskCode')"
        width="140"
      />
      <el-table-column
        prop="from_version"
        :label="t('systemUpdate.taskTab.columnFromVersion')"
        width="100"
      />
      <el-table-column
        prop="to_version"
        :label="t('systemUpdate.taskTab.columnToVersion')"
        width="100"
      />
      <el-table-column
        prop="status"
        :label="t('systemUpdate.taskTab.columnStatus')"
        width="120"
        align="center"
      >
      ...
      <el-table-column
        prop="progress"
        :label="t('systemUpdate.taskTab.columnProgress')"
        width="150"
      >
        <template #default="{ row }">
          <el-progress
      ...
      <el-table-column
        prop="started_at"
        :label="t('systemUpdate.taskTab.columnStartedAt')"
        width="160"
      />
      <el-table-column
        prop="completed_at"
