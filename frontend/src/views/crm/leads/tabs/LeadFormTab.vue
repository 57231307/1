...
<template>
  ...
  >
    <el-form
      ...
      :rules="formRules"
      label-width="100px"
      :aria-label="t('crmLeads.leadForm.ariaLabel')"
    >
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="t('crmLeads.leadForm.leadSource')" prop="lead_source">
            <el-select
              ...
              :placeholder="t('crmLeads.leadForm.leadSourcePlaceholder')"
            >
              ...
              <el-option
                :label="t('crmLeads.leadForm.leadSourceOption.exhibition')"
                value="EXHIBITION"
              />
              <el-option
                :label="t('crmLeads.leadForm.leadSourceOption.referral')"
                value="REFERRAL"
              />
        ...
        <el-col :span="12">
          <el-form-item :label="t('crmLeads.leadForm.priority')" prop="priority">
            <el-select
              ...
              :placeholder="t('crmLeads.leadForm.priorityPlaceholder')"
            >
        ...
        <el-col :span="12">
          <el-form-item :label="t('crmLeads.leadForm.companyName')" prop="company_name">
            <el-input
              ...
              :placeholder="t('crmLeads.leadForm.companyNamePlaceholder')"
            />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="t('crmLeads.leadForm.contactName')" prop="contact_name">
            <el-input
              ...
              :placeholder="t('crmLeads.leadForm.contactNamePlaceholder')"
            />
          </el-form-item>
        </el-col>
      </el-row>
        ...
        <el-col :span="12">
          <el-form-item :label="t('crmLeads.leadForm.mobilePhone')" prop="mobile_phone">
            <el-input
              ...
              :placeholder="t('crmLeads.leadForm.mobilePhonePlaceholder')"
            />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="t('crmLeads.leadForm.email')" prop="email">
            <el-input
              ...
              :placeholder="t('crmLeads.leadForm.emailPlaceholder')"
            />
          </el-form-item>
        </el-col>
      </el-row>
        ...
        <el-col :span="12">
          <el-form-item :label="t('crmLeads.leadForm.contactTitle')" prop="contact_title">
            <el-input
              ...
              :placeholder="t('crmLeads.leadForm.contactTitlePlaceholder')"
            />
          </el-form-item>
        </el-col>
        <el-col :span="12">
...
const formRules: FormRules = {
  lead_source: [
    {
      required: true,
      message: t('crmLeads.leadForm.validation.leadSourceRequired'),
      trigger: 'change',
    },
  ],
  contact_name: [
    {
      required: true,
      message: t('crmLeads.leadForm.validation.contactNameRequired'),
      trigger: 'blur',
    },
  ],
  owner_id: [
