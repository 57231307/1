...
<template>
  <el-dialog v-model="visible" :title="title" width="800px" :close-on-click-modal="false" :aria-label="title">
    <el-form ref="formRef" :model="formData" :rules="formRules" label-width="100px" :aria-label="t('crmOpportunityForm.ariaLabel')">
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="t('crmOpportunityForm.opportunityName')" prop="opportunity_name">
            <el-input v-model="formData.opportunity_name" :placeholder="t('crmOpportunityForm.opportunityNamePlaceholder')" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="t('crmOpportunityForm.customer')" prop="customer_id">
            <el-select v-model="formData.customer_id" :placeholder="t('crmOpportunityForm.customerPlaceholder')" filterable>
              <el-option
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="t('crmOpportunityForm.opportunityType')" prop="opportunity_type">
            <el-select v-model="formData.opportunity_type" :placeholder="t('crmOpportunityForm.opportunityTypePlaceholder')">
              <el-option :label="t('crmOpportunityForm.opportunityTypeOption.new')" value="NEW" />
              <el-option :label="t('crmOpportunityForm.opportunityTypeOption.upsell')" value="UPSELL" />
              <el-option :label="t('crmOpportunityForm.opportunityTypeOption.renewal')" value="RENEWAL" />
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="t('crmOpportunityForm.opportunityStage')" prop="opportunity_stage">
            <el-select v-model="formData.opportunity_stage" :placeholder="t('crmOpportunityForm.opportunityStagePlaceholder')">
              <el-option :label="t('crmOpportunityForm.stageOption.initial')" value="INITIAL" />
              <el-option :label="t('crmOpportunityForm.stageOption.requirement')" value="REQUIREMENT" />
              <el-option :label="t('crmOpportunityForm.stageOption.proposal')" value="PROPOSAL" />
              <el-option :label="t('crmOpportunityForm.stageOption.negotiation')" value="NEGOTIATION" />
            </el-select>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="t('crmOpportunityForm.expectedCloseDate')" prop="expected_close_date">
            <el-date-picker
        ...
        <el-col :span="12">
          <el-form-item :label="t('crmOpportunityForm.owner')" prop="owner_id">
            <el-select v-model="formData.owner_id" :placeholder="t('crmOpportunityForm.ownerPlaceholder')" filterable>
      ...
      <el-form-item :label="t('crmOpportunityForm.remarks')" prop="remarks">
        <el-input v-model="formData.remarks" type="textarea" :rows="2" :placeholder="t('crmOpportunityForm.remarksPlaceholder')" />
      </el-form-item>
    </el-form>
    <template #footer>
      <el-button @click="visible = false">{{ t('crmOpportunityForm.cancel') }}</el-button>
      <el-button type="primary" :loading="submitLoading" @click="handleSubmit">{{ t('crmOpportunityForm.confirm') }}</el-button>
    </template>
  </el-dialog>
</template>
...
const formRules: FormRules = {
  opportunity_name: [{ required: true, message: t('crmOpportunityForm.validation.opportunityNameRequired'), trigger: 'blur' }],
  customer_id: [{ required: true, message: t('crmOpportunityForm.validation.customerRequired'), trigger: 'change' }],
  opportunity_stage: [{ required: true, message: t('crmOpportunityForm.validation.stageRequired'), trigger: 'change' }],
  owner_id: [{ required: true, message: t('crmOpportunityForm.validation.ownerRequired'), trigger: 'change' }],
}
