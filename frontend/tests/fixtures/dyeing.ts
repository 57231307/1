...
export function createInProgressDyeBatchMock(overrides: Partial<DyeBatch> = {}): DyeBatch {
...
export function createCompletedDyeBatchMock(overrides: Partial<DyeBatch> = {}): DyeBatch {
  return createDyeBatchMock({
    status: 'completed',
    actual_quantity: 500,
    ...overrides,
...
/** 创建已取消染缸批次 mock */
export function createCancelledDyeBatchMock(overrides: Partial<DyeBatch> = {}): DyeBatch {
  return createDyeBatchMock({
    status: 'cancelled',
    remark: '计划变更取消',
    ...overrides,
