with open("src/pages/ar_invoice.rs", "r") as f:
    content = f.read()

# 1. Add fields to struct
content = content.replace("    viewing_item: Option<ArInvoice>,}", "    viewing_item: Option<ArInvoice>,\n    printing_invoice: Option<ArInvoice>,\n    print_trigger: bool,}")
...
content = content.replace("        html! {\n            <div class=\"ar-invoice-page\">", "        html! {\n            <div class=\"ar-invoice-page\">" + style)

with open("src/pages/ar_invoice.rs", "w") as f:
    f.write(content)
