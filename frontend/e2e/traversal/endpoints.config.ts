...
export const NON_SENSITIVE_EXPORT_ENDPOINTS: string[] = [
  '/finance/ap/invoices/export',
  '/finance/ar/invoices/export',
  '/audit-logs/export-logs',
  '/finance/budgets/export',
  '/production/cost-collections/export',
  '/production/dye-batches/export',
  '/production/energy-allocations/export',
  '/production/energy-consumptions/export',
  '/finance/fixed-assets/export',
  ...
  '/finance/subjects/export',
  '/finance/vouchers/export',
  '/production/wage-records/export',
  '/warehouses/export',
];
...
export const APPROVE_ENDPOINTS: Array<{
  ...
  { path: '/finance/ap/invoices/{id}/approve', entity: 'ap_invoice', createApi: '/finance/ap/invoices' },
  { path: '/finance/ap/payment-requests/{id}/approve', entity: 'ap_payment_request', createApi: '/finance/ap/payment-requests' },
  { path: '/finance/ap/payment-requests/{id}/reject', entity: 'ap_payment_request', createApi: '/finance/ap/payment-requests' },
  { path: '/finance/ar/invoices/{id}/approve', entity: 'ar_invoice', createApi: '/finance/ar/invoices' },
  ...
  { path: '/production/dye-recipes/{id}/approve', entity: 'dye_recipe', createApi: '/production/dye-recipes' },
  ...
  { path: '/sales/orders/{id}/approve', entity: 'order', createApi: '/sales/orders' },
  { path: '/sales/orders/{id}/reject', entity: 'order', createApi: '/sales/orders' },
  { path: '/production/production-orders/orders/{id}/approve', entity: 'production_order', createApi: '/production/production-orders/orders' },
