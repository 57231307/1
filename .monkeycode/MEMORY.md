...
> 最近整理：2026-07-14（三次修正：规则 15 下"四、v14 新一轮复审"详细内容移到 audit_assignment.md §2.2，MEMORY.md 只保留规则要求）。
...
> v14 复审各维度**详细检查要点**（待执行任务）见 [doto.md](file:///workspace/.monkeycode/doto.md) 阶段 10。
