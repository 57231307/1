...
> 本文件是项目规则的**索引版**，每条规则仅保留一句话核心 + 链接到详细说明。
> **详细执行要求、修复模式参考、迭代历史见 [MEMORY-SU.md](file:///workspace/.monkeycode/MEMORY-SU.md)**。
> 历史归档与详细内容请查阅 [`.monkeycode/docs/archives/`](file:///workspace/.monkeycode/docs/archives/)。
> 最近整理：2026-07-17（三次迭代：拆分 MEMORY.md/MEMORY-SU.md，MEMORY.md 精简为索引版，详细内容迁移到 MEMORY-SU.md）。
...
| 🔴 **规则 13** | PR | 修复按批次连续执行，CI 全绿自动下一批，每批 6-8 文件 | [MEMORY-SU §规则 13](file:///workspace/.monkeycode/MEMORY-SU.md#规则-13修复流程自动化与连续执行pr2026-07-11-追加) |
...
- 规则 0-19 来源分类：[MEMORY-SU §11.1](file:///workspace/.monkeycode/MEMORY-SU.md#111-现有规则来源分类2026-07-17-反向标注)
- 个人习惯观察（IH）：[MEMORY-SU §11.2](file:///workspace/.monkeycode/MEMORY-SU.md#112-个人习惯观察ih)
- 项目习惯观察（PH）：[MEMORY-SU §11.3](file:///workspace/.monkeycode/MEMORY-SU.md#113-项目习惯观察ph)

### 8.2 近期迭代记录

| 日期 | 操作 | 规则 | 摘要 |
|------|------|------|------|
| 2026-07-17 | 拆分 | MEMORY.md/MEMORY-SU.md | MEMORY.md 精简为索引版，详细内容迁移到 MEMORY-SU.md |
| 2026-07-17 | 修正 | 规则 13 | 批次文件数从 1-3 升级为 6-8（消除规则内部矛盾） |
| 2026-07-17 | 增强 | 规则 19 | 工具连接异常重试策略升级为分级响应（L1/L2/L3）+ 非阻塞推理 |
| 2026-07-17 | 新增 | IH 批次大小偏好 | 11.2 新增"批次大小偏好"行（6-8 文件） |
| 2026-07-17 | 补录 | 规则 19 | 11.1 来源分类表补录规则 19 |
| 2026-07-17 | 新增 | 规则 18 | 规则自我迭代机制（四分类 + 6 触发条件 + 自动记录） |
| 2026-07-17 | 新增 | 规则 17 | 审计文档同步规则（5 关联文档同步） |
| 2026-07-17 | 新增 | 规则 16 | .monkeycode 全目录强制追踪 |
| 2026-07-17 | 精简 | 规则 15 | v13/v14/V15 已完成内容精简为完成状态表 |
| 2026-07-17 | 合并 | 规则 8 → 规则 0 | 真实实现强制合并，保留规则 8 编号 |

> 完整迭代日志见 [MEMORY-SU §11.4](file:///workspace/.monkeycode/MEMORY-SU.md#114-迭代记录)
