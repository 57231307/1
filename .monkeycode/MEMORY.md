...
**整理记录**：
- 2026-07-14（批次 390 后，轻量整理）：批次 390 完成useTableApi-8/9（assistAccounting + barcodeScanner 0-based 分页 bug 修复，PR #563 已合并 CI 全绿）；更新 doto.md 进度总览（86 完成 / 292 剩余）+ CHANGELOG.md 追加批次 390 记录 + doto.md 批次 390 表格补全实际完成状态 + 批次 391 调整为剩余 view 扫描；下一个整理点批次 405
