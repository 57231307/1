...
| 优先级 | 漏洞 | 状态 |
|--------|------|------|
| P0 | 1.1 SQL 注入 (LIMIT) | ✅ 已修复（批次 290） |
| P0 | 1.2 命令注入 (backup) | ✅ 已修复（批次 291） |
| P0 | 1.3 SSRF (currency) | ✅ 已修复（批次 292） |
| P1 | 2.1 日志泄露 | ✅ 已修复（批次 293） |
| P1 | 2.2 速率限制 | ✅ 已修复（批次 294） |
| P1 | 2.3 文件权限 | ✅ 已修复（批次 295） |
| P2 | 3.2 备份权限 | ✅ 已修复（批次 296） |
