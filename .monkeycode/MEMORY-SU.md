...
> 第 8 次迭代（2026-07-17，梳理合并排序：11 章压缩为 6 章 + project_rules.md 删除后改为内联说明 + 11.4 迭代记录精简）
...
#### [2026-07-17] 精简 MEMORY.md/MEMORY-SU.md 顶部说明（四次迭代）
- **触发条件**：用户明确指令"顶部说明只需要保留:本文件是项目的规则记忆，记录必须遵守的规则、指令、偏好和工作流规范。第**次迭代（****-**-**）"
- **分类**：PR（项目规则）+ IH（个人习惯：简洁高效专业速度）
- **来源上下文**：用户 2026-07-17 四次迭代，要求 MEMORY.md/MEMORY-SU.md 顶部说明只保留两行（规则记忆定位 + 迭代次数）
- **迭代内容**：
  1. MEMORY.md 顶部精简为：`> 本文件是项目的规则记忆，记录必须遵守的规则、指令、偏好和工作流规范。` + `> 第 4 次迭代（2026-07-17）`
  2. MEMORY-SU.md 顶部精简为：`> 本文件是项目的规则记忆详细说明，记录必须遵守的规则、指令、偏好和工作流规范。` + `> 第 4 次迭代（2026-07-17）`
  3. 移除冗余的"索引版/详细说明版"说明、链接、归档索引等顶部内容
- **验证**：✅ 顶部仅保留 2 行 / ✅ 迭代次数正确标注为第 4 次 / ✅ 日期格式 YYYY-MM-DD
