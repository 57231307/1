...
> 本文件是 [MEMORY.md](file:///workspace/.monkeycode/MEMORY.md) 的**详细说明版**，包含每条规则的完整执行要求、修复模式参考、迭代历史。
> MEMORY.md 只保留规则一句话核心 + 链接到本文件对应章节，确保代理快速定位规则。
> 最近整理：2026-07-17（从 MEMORY.md 拆分详细内容至本文件，MEMORY.md 精简为索引版）。
