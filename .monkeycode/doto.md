...
> **已完成批次**：356-385（详见 [CHANGELOG.md](file:///workspace/.monkeycode/CHANGELOG.md)）
...
| 业务场景闭环 | 21 | 18 | 3 | 🔄 P0 6/6 ✅ + P1 9/9 ✅ + P2 3/6（批次 385 完成 B-P2-1/2/3） |
| 财务场景闭环 | 16 | 9 | 7 | 🔄 **P0 8/8 ✅** + **P1 6/6 ✅**（批次 384 完成 F-P1-1 期末结转） |
