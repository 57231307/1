...
> 最近整理：2026-07-29（doto.md 更新：P1-20 批次 1 已合并 PR #768；P1-21+22 胚布拆匹 10 项 P1 + 库存排程 9 项 P1 全部修复完成待 PR；P1 已合并批次从 17 批增至 18 批，P1-21+22 待 PR 合并后为 19 批）
...
| 状态 | 数量 | 批次 |
|------|------|------|
| ✅ 已合并到 main | 18 批 | P1-A、P1-B1、P1-B2、P1-C、P1-面料行业深化（batch-04+05）、P1-D（batch-08+20）、P1-batch13/14、P1-Batch16、P1-batch11/12、P1-batch19、P1-08 法律合规第二批（PR #758）、P1-09 色卡发放（9 项，PR #763）、P1-10 大货批色（7 项，PR #763）、P1-19 报表 BI（5 项，PR #763）、P1-25 部署升级（11 项，PR #758 + #763）、P1-B3 法律合规扩展（PR #765）、P1-07 剩余可维护性（PR #767）、P1-20 可观测性批次 1（PR #768，3 项 P1） |
| 🔄 待 PR | 1 批 | P1-21 胚布拆匹（10 项 P1）+ P1-22 库存排程（9 项 P1）合并提交，10 文件 +969 -32 |
| ❌ 未开始 | 剩余约 5 批 | P1-20 批次 2-3（20.4-3 流复制 + 20.7-1 灰度升级等）+ 其他模块 P1 批次 |
...
| ~~P1-20 批次 1~~ | ~~类二十 可观测性~~ | ~~3~~ | ~~trace/metrics/WebSocket~~ **✅ 已完成（2026-07-29，PR #768 已合并：20.8-1 日志 JSON + 20.1-1 trace HTTP + 20.6-2 API 熔断）** |
| ~~P1-21~~ | ~~类二十一 胚布拆匹~~ | ~~10~~ | ~~库存/委外/继承~~ **🔄 待 PR 提交（2026-07-29，10 项 P1 全部修复完成：缺陷 1.1/1.2/2.1/2.2/3.1/3.3/4.2/4.3/5.1/5.3，详见 CHANGELOG.md）** |
| ~~P1-22~~ | ~~类二十二 库存排程~~ | ~~9~~ | ~~调拨/安全/排程~~ **🔄 待 PR 提交（2026-07-29，9 项 P1 全部修复完成：缺陷 6.1/6.2/7.1/7.2/8.2/9.1/10.1/11.1/11.3，详见 CHANGELOG.md）** |
...
| P1-20 批次 2-3 | 类二十 可观测性 | 6 | 20.4-3 流复制 + 20.7-1 灰度升级 + 其他可观测性 P1 项 |
