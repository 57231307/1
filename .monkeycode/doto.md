...
> 最近整理：2026-07-29（doto.md 更新：P1-20 可观测性批次 1 已合并 PR #768（20.8-1 日志 JSON + 20.1-1 trace HTTP 传递 + 20.6-2 API 熔断，13/14 CI 全绿 Clippy 超时 admin 合并）；P1-07 已合并 PR #767；P1 已合并批次从 16 批增至 18 批）
...
| P1-20 | 类二十 可观测性 | 9 | trace/metrics/WebSocket **✅ 批次 1 已合并 PR #768（3 项：20.8-1 日志 JSON + 20.1-1 trace HTTP + 20.6-2 API 熔断），剩余批次 2-3（20.4-3 流复制 + 20.7-1 灰度升级等 6 项）** |
