...
| v14 中风险遗留 | 3 大类 | 3 批 | 3 大类 | 🔄 v14 复审 P0 已完成 4 批（批次 416 ✅ 数据模型基础 + 批次 417 ✅ 业务字段补全 + 批次 418 ✅ 数据流转修复 + 批次 419 ✅ 生产订单/色卡补全），**P0 全部修复完成**，进入 P1 修复（批次 420+） |
...
> **批次 420 状态**：🔄 进行中（P1 第一批：事件贯通修复 T-P1-1/2/3 + G-P1-3）
