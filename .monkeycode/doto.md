...
## 🔥 当前任务：v10 复审问题修复（P0 1/1 ✅，P1 5/5 ✅，P2 0/4 ⏳，P3 0/~42 ⏳）
...
| 🟡 P2 clippy 代码味道 | 4 | 0 | 4 | ⏳ 待修复（批次 326） |
| 🟢 P3 too_many_arguments | ~42 | 0 | ~42 | ⏳ 长期重构（批次 327+） |
| **合计** | **~52** | **6** | **~46** | 🔄 进行中 |
...
**批次 326 计划**：clippy 代码味道修复 4 项
- `ai/pred.rs:90,101`：needless_range_loop 2 处（改 iterator）
- `sales_analysis_service.rs:228`：needless_late_init 1 处（合并声明+赋值）
- `material_shortage_service.rs:205`：type_complexity 1 处（提取类型别名）
