...
> 最近整理：2026-07-16（V15 修复阶段 Batch 433-436 完成，6/104 P0 已修复；剩余 98 P0 + 257 P1 + 248 P2 + 123 P3；重新规划为小粒度批次，每批 3-5 文件）。
...
|------|---------|--------|----------|------|
| 437 | P0-S18 dye_recipe_master 角色创建 | 2 | 1 | 🔄 下一个 |
| 438 | P0-S07 权限缓存不失效 | 3 | 2 | ⏳ |
| 439 | P0-S05 SoD 职责分离互斥 | 3 | 3 | ⏳ |
| 440 | P0-S06 权限变更审计 | 3 | 4 | ⏳ |
| 441 | P0-S10 method_to_action 升级 | 2 | 5 | ⏳ |
| 442-444 | P0-S09 打印导出 AuthContext 补齐 | 13 | 6-8 | ⏳ |
| 445-446 | P0-S11 导出审计日志补齐 | 10 | 9-10 | ⏳ |
| 447 | P0-S01 service 注入-销售域 | 5 | 11 | ⏳ |
| 448 | P0-S01 service 注入-采购域 | 4 | 12 | ⏳ |
| 449 | P0-S01 service 注入-生产域 | 5 | 13 | ⏳ |
| 450 | P0-S01 service 注入-CRM 域 | 4 | 14 | ⏳ |
| 451 | P0-S01 service 注入-财务域 | 5 | 15 | ⏳ |
| 452 | P0-S01 service 注入-库存域 | 4 | 16 | ⏳ |
| 453-456 | P0-S02 IDOR 防护-handler 层 | 20 | 17-20 | ⏳ |
| 457+ | P0-S08/S23/S24/S25/S26/S27/S28 | - | 21+ | ⏳ |
