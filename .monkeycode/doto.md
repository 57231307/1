...
- **批次规划**：
  ...
  - 第 3 批：✅ chemical_service.rs (1676→349) + ✅ bi_analysis_service.rs (1662→317) + ✅ models/status.rs (1577→已拆分为 status/ 目录 9 子文件) + ✅ mrp_engine_service.rs (1556→603 facade + mrp_engine_ops/ 7 子模块) 4 个 >1500 行文件全部完成
  - 第 4 批：dye_batch_state_machine_service.rs (1512) + wage_service.rs (1507→**1621**核实逆生长) + ar/vfy.rs (1320→**1368**核实逆生长) + ap_invoice_service.rs (1306→**1405**核实逆生长) 4 个 >1300 行文件
