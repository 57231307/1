...
> 最近整理：2026-07-28（doto.md 精简：移除已完成批次清单 0.2-0.8 节 + 四/五/六节，归档到 doto-su.md/CHANGELOG.md；保留未完成任务规划 + 待启动批次 + P1/P2/P3 规划 + 规则提醒）
...
| P1-25 | 类二十五 部署升级 | 11 | set -euo/SHA256/schema/蓝绿/健康/优雅/回滚 |
