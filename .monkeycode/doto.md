...
> 最近整理：2026-07-17（V15 修复阶段 Batch 433-460 已完成 P0 任务归档到 doto-su.md；P0 进度 49/104；剩余 55 P0 + 257 P1 + 248 P2 + 123 P3；批次大小每批 6-8 文件；用户指令变更：仅执行单数（奇数）批次，双数批次跳过，Batch 460 已合并后续从 461 起）。
...
| 优先级 | 总数 | 已完成 | 未完成 | 完成率 |
|--------|------|--------|--------|--------|
| **P0 阻塞级** | 104 | 49 | **55** | 47.1% |
| **P1 高优先级** | 257 | 0 | **257** | 0% |
| **P2 中优先级** | 248 | 0 | **248** | 0% |
| **P3 低优先级** | 123 | 0 | **123** | 0% |
| **合计** | **732** | **49** | **683** | **6.7%** |

### 1.1 已完成 P0 任务（17 项，详情见 [doto-su.md](file:///workspace/.monkeycode/doto-su.md#-v15-修复阶段已完成-p0-任务归档批次-433-4602026-07-16--2026-07-17)）

P0-S01（主体完成）/ P0-S02 / P0-S03 / P0-S04 / P0-S05 / P0-S06 / P0-S07 / P0-S09 / P0-S10 / P0-S11 / P0-S18 / P0-S20 / P0-S21 / P0-S22 / P0-S23 / P0-S26 / P0-S27
...
> **用户指令变更（2026-07-17）**：仅修复单数（奇数）批次，双数批次跳过。
> 已合并双数批次（如 460）后从下一个奇数批次开始。

| 批次 | P0 任务 | 文件数 | 状态 |
|------|---------|--------|------|
| 461 | P0-S08 CRM 数据权限完全缺失（lead/opportunity owner_id+data_scope） | - | ⏳ |
| 463 | P0-S24 | - | ⏳ |
| 465 | P0-S25 | - | ⏳ |
| 467 | P0-S28 | - | ⏳ |
| 469+ | P0-F01~F21 面料行业核心特性（按奇数批次推进） | - | ⏳ |
