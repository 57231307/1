...
| ⏳ 进行中 | 1 | D10（1000 行文件拆分，第 6 批 1/4 完成，待推进第 6b 批） |
...
- **批次规划**：
  ...
  - 第 6a 批：✅ event_bus.rs (1243→338 facade + event_bus_ops/{mod 20, kafka 110, listener 847}) + ✅ po/order.rs (1234→561 facade含测试 + po/order_ops/{mod 19, crud 536, lifecycle 66, query 137}) + ✅ auth_service.rs (1201→621 facade含测试 + auth_service_ops/{mod 13, auth 256, jti 374}) + ✅ inventory_finance_bridge_service.rs (1192→108 facade + inventory_finance_bridge_ops/{mod 14, listener 202, voucher 925}) 4 个 >1180 行文件全部完成（PR #698 main 9d26d7d，CI 一次通过 Clippy+后端构建+单元测试全绿）
  - 第 6b 批（待推进）：剩余 11 个 1000-1200 行文件：lab_dip_service.rs (1188) / production_recipe_service.rs (1181) / product_service.rs (1075) / system_update_service.rs (1074) / purchase_receipt_service.rs (1074) / ar/recon.rs (1070) / ar_ops/verification.rs (1062 ⚠️ D10-1 副产物) / bpm_service.rs (1060) / bom_service.rs (1046) / import_export_service.rs (1018) / main.rs (1005)
