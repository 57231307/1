...
> **已完成批次**：356-397（详见 [CHANGELOG.md](file:///workspace/.monkeycode/CHANGELOG.md)）
...
| v14 低风险遗留 | 74 | 4 | 70 | 🔄 批次 397 完成 4 处 unwrap_or_default 安全修复 + 占位符调研（21 项已清零，9 处 TODO 合理保留） |
...
| 400 ✅ | 项目规则符合性 | 4 | 3 项 #[allow(dead_code)] 接入/删除 + 1 项警告抑制收窄 |
| 401 ✅ | 项目规则符合性剩余 | 7 | 5 个占位模块删除 + 2 处注释更新（安全设计明确），build_product_doc JOIN 修复留到下批 |
