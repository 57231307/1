                    ...
                    <div class="grid grid-cols-1 gap-3 pb-20">
                        {
                            for filtered_products.iter().enumerate().map(|(i, product)| {
                                let is_knit = i % 2 == 0; // Mock data for presentation
                                    ...
                                    if filtered_products.is_empty() {
                                    ...
                                    } else {
                                        {
                                            for filtered_products.iter().enumerate().map(|(index, product)| {
                                                let is_knit = index % 2 == 0; // Mock logic
                                                let badge_class = if is_knit { "badge-knit" } else { "badge-woven" };
                                                let badge_text = if is_knit { "针织" } else { "梭织" };
                                                ...
                                                html! {
                                                    <tr key={product.id}>
                                                        ...
                                                        <td>
                                                            <div class="w-10 h-10 bg-gray-200 rounded flex items-center justify-center text-gray-400 cursor-pointer hover:opacity-80">
