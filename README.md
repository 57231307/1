...
| 前端 Views 子模块 | 110 个                                                                                                                        |
| 前端 API 模块     | 121 个                                                                                                                        |
| 前端 i18n 翻译键  | zh-CN 10,192 / en-US 10,215（引用键 9,675，缺失校验 0；常量表内的键名由 `tests/unit/translated-value-select.test.ts` 校验）                                                                       |
...
| 层级                  | 数量                  | 工具                  | 覆盖范围                                                                             |
| --------------------- | --------------------- | --------------------- | ------------------------------------------------------------------------------------ |
| 后端集成测试          | 256 文件 / 2,089 函数 | cargo test + nextest  | 服务层 + API 层                                                                      |
