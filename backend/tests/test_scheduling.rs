...
mod tests {
    ...
    fn test_schedule_detail_creation() {
        // 测试排程明细创建
        let detail = super::super::scheduling_service::ScheduleDetail {
            order_id: 1,
    ...
    fn test_gantt_item_creation() {
        // 测试甘特图数据项创建
        let item = super::super::scheduling_service::GanttItem {
    ...
    fn test_schedule_conflict_creation() {
        // 测试排程冲突创建
        let conflict = super::super::scheduling_service::ScheduleConflict {
    ...
    fn test_auto_schedule_request_creation() {
        // 测试自动排程请求创建
        let request = super::super::scheduling_service::AutoScheduleRequest {
    ...
    fn test_date_range_creation() {
        // 测试日期范围创建
        let range = super::super::scheduling_service::DateRange {
