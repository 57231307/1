...
ALTER TABLE "color_cards" ADD COLUMN IF NOT EXISTS "description" TEXT;
...
ALTER TABLE "permission_change_audits" ADD COLUMN IF NOT EXISTS "new_value" JSONB;
ALTER TABLE "permission_change_audits" ADD COLUMN IF NOT EXISTS "old_value" JSONB;
...
ALTER TABLE "role_conflicts" ADD COLUMN IF NOT EXISTS "description" TEXT;
