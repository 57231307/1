...
ALTER TABLE "inventory_count_items" ADD COLUMN IF NOT EXISTS "color_no" VARCHAR(255) NOT NULL DEFAULT '';
...
ALTER TABLE "inventory_transfer_items" ADD COLUMN IF NOT EXISTS "color_no" VARCHAR(255) NOT NULL DEFAULT '';
UPDATE "inventory_transfer_items" SET "color_no" = '' WHERE "color_no" IS NULL;
ALTER TABLE "inventory_transfer_items" ADD COLUMN IF NOT EXISTS "dye_lot_no" VARCHAR(255) NOT NULL DEFAULT '';
UPDATE "inventory_transfer_items" SET "dye_lot_no" = '' WHERE "dye_lot_no" IS NULL;
...
ALTER TABLE "sales_orders" ADD COLUMN IF NOT EXISTS "batch_no" VARCHAR(50) NOT NULL DEFAULT '';
UPDATE "sales_orders" SET "batch_no" = '' WHERE "batch_no" IS NULL;
ALTER TABLE "sales_orders" ADD COLUMN IF NOT EXISTS "color_no" VARCHAR(50) NOT NULL DEFAULT '';
UPDATE "sales_orders" SET "color_no" = '' WHERE "color_no" IS NULL;
ALTER TABLE "sales_orders" ADD COLUMN IF NOT EXISTS "dye_lot_no" VARCHAR(50) NOT NULL DEFAULT '';
UPDATE "sales_orders" SET "dye_lot_no" = '' WHERE "dye_lot_no" IS NULL;
ALTER TABLE "sales_orders" ADD COLUMN IF NOT EXISTS "grade" VARCHAR(20) NOT NULL DEFAULT '';
UPDATE "sales_orders" SET "grade" = '' WHERE "grade" IS NULL;
ALTER TABLE "sales_orders" ADD COLUMN IF NOT EXISTS "packaging_requirement" VARCHAR(200) NOT NULL DEFAULT '';
UPDATE "sales_orders" SET "packaging_requirement" = '' WHERE "packaging_requirement" IS NULL;
ALTER TABLE "sales_orders" ADD COLUMN IF NOT EXISTS "quality_standard" VARCHAR(200) NOT NULL DEFAULT '';
UPDATE "sales_orders" SET "quality_standard" = '' WHERE "quality_standard" IS NULL;
