...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        let sql = r#"-- 管理系统 - 初始数据库架构
-- 创建时间: 2026-03-23
-- 描述: 系统初始化数据库表结构

-- users, roles, departments are created via Fluent API in m0001_initial_schema.rs
...
CREATE TABLE "inventory_stocks" (
    ...
    "available_quantity" NUMERIC(20,4) GENERATED ALWAYS AS (quantity - reserved_quantity) STORED,
...
CREATE TABLE "inventory_transfers" (
    ...
    "total_quantity" NUMERIC(20,4) DEFAULT 0,
    "notes" TEXT,
    "created_by" INTEGER,
    "approved_by" INTEGER,
    "is_deleted" BOOLEAN NOT NULL DEFAULT FALSE,
...
CREATE TABLE "inventory_count_items" (
    ...
    "product_id" INTEGER NOT NULL,
    "batch_no" VARCHAR(50),
    "system_quantity" NUMERIC(20,4) DEFAULT 0,
    "actual_quantity" NUMERIC(20,4) DEFAULT 0,
    "discrepancy_quantity" NUMERIC(20,4) DEFAULT 0,
    "unit_cost" DECIMAL(12, 2) DEFAULT 0,
