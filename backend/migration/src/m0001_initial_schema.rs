    ...
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(Roles::Code).string_len(50).not_null().unique_key())
                ...
                .col(ColumnDef::new(Roles::IsDeleted).boolean().not_null().default(false))
        ...
        manager.create_table(
            Table::create()
                ...
                .if_not_exists()
                .col(ColumnDef::new(Departments::Id).integer().not_null().auto_increment().primary_key())
                .col(ColumnDef::new(Departments::Name).string_len(100).not_null())
                .col(ColumnDef::new(Departments::Code).string_len(50).not_null().unique_key())
                ...
                .col(ColumnDef::new(Departments::IsActive).boolean().default(true))
                .col(ColumnDef::new(Departments::IsDeleted).boolean().not_null().default(false))
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(Users::IsDeleted).boolean().not_null().default(false))
