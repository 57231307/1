...
use crate::handlers::{
    ...
    quality_inspection_handler, quality_standard_handler, role_handler, sales_analysis_handler,
    sales_contract_handler, sales_fabric_order_handler, sales_order_handler, sales_price_handler,
    sales_return_handler, supplier_evaluation_handler, supplier_handler, system_update_handler,
    user_handler, voucher_handler, warehouse_handler,
};
...
pub fn create_router(state: AppState) -> Router {
    ...
    let sales_routes = Router::new()
        .route(
            "/deliveries",
            post(crate::handlers::sales_delivery_handler::create_delivery)
                .get(crate::handlers::sales_delivery_handler::list_deliveries),
        )
    ...
    let supplier_routes = Router::new()
        ...
        .route(
            "/:id/contacts",
            get(crate::handlers::supplier_handler::list_supplier_contacts)
                .post(crate::handlers::supplier_handler::create_supplier_contact),
        )
        .route(
            "/contacts/:contact_id",
            put(crate::handlers::supplier_handler::update_supplier_contact)
                .delete(crate::handlers::supplier_handler::delete_supplier_contact),
        )
        .route(
            "/:id/qualifications",
            get(crate::handlers::supplier_handler::list_supplier_qualifications)
                .post(crate::handlers::supplier_handler::create_supplier_qualification),
        )
        .route(
            "/qualifications/:qual_id",
            put(crate::handlers::supplier_handler::update_supplier_qualification)
                .delete(crate::handlers::supplier_handler::delete_supplier_qualification),
        );
    ...
    let purchase_routes = Router::new()
        ...
        .route(
            "/returns/:id/submit",
            post(purchase_return_handler::submit_return),
        )
        .route(
            "/returns/:id/approve",
        ...
        .route(
            "/returns/:id/reject",
            post(purchase_return_handler::reject_return),
        )
        .route(
            "/returns/:id/items",
            get(purchase_return_handler::list_items),
        )
        .route(
            "/returns/:id/items",
            post(purchase_return_handler::create_item),
        )
        .route(
            "/returns/:id/items/:item_id",
            put(purchase_return_handler::update_item),
        )
        .route(
            "/returns/:id/items/:item_id",
            delete(purchase_return_handler::delete_item),
        );
    ...
    let ap_routes = Router::new()
        ...
        .route(
            "/invoices/balance",
            get(crate::handlers::ap_invoice_handler::get_balance_summary),
        )
        ...
        .route(
            "/invoices/:id/approve",
            post(ap_invoice_handler::approve_invoice),
        )
        .route(
            "/invoices/:id/cancel",
            post(ap_invoice_handler::cancel_invoice),
        )
        .route(
    ...
    Router::new()
        ...
        .nest(
            "/api/v1/erp/supplier-evaluations",
