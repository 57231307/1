...
pub async fn list_requests(
    ...
    let (requests, total) = service.get_list(
        params.supplier_id,
...
pub async fn get_request(
    ...
    info!("用户 {} 查询付款申请详情成功：{}", auth.username, request.request_no);
...
pub async fn update_request(
    ...
    info!("用户 {} 更新付款申请成功：{}", auth.username, request.request_no);
...
pub async fn delete_request(
    ...
    Ok(Json(ApiResponse::success_with_message((), "付款申请删除成功")))
}
...
pub async fn submit_request(
    ...
    info!("用户 {} 提交付款申请成功：{}", auth.username, request.request_no);
...
pub async fn approve_request(
    ...
    info!("用户 {} 审批付款申请通过：{}", auth.username, request.request_no);
...
pub async fn reject_request(
    ...
    info!("用户 {} 拒绝付款申请 ID: {}, 原因：{}", auth.username, id, req.reason);
    
    let service = ApPaymentRequestService::new(db);
    let request = service.reject(id, req.reason, auth.user_id).await?;
    
    info!("用户 {} 拒绝付款申请成功：{}", auth.username, request.request_no);
