//! 凭证服务-辅助核算子模块（voucher_ops/assist）
//!
//! 批次 488 D10-4 拆分：从原 `voucher_service.rs` L1052-1256 迁移。
//! 包含 11 个辅助核算方法：
//! - write_assist_accounting_records_txn（pub(crate)，state.rs 的 post 调用）
...
use crate::services::voucher_ops::types::AssistRecordContext;
