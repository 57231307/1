...
impl InitService {
    ...
    async fn create_default_roles(&self) -> Result<role::Model, InitError> {
        ...
        let business_roles: Vec<role::ActiveModel> = [
            ...
            ("寻源专员", "sourcing_specialist", "供应商开发与寻源询价"),
            // 库存仓储域
            ...
            ("后整理主管", "finishing_master", "定型预缩柔软等后整理工序"),
            ("化验室技术员", "lab_technician", "打样配方开发与颜色管理"),
            ("胚布管理员", "greige_manager", "胚布采购库存与委托加工"),
            ("染化料管理员", "chemical_manager", "染料助剂化学品采购存储领用"),
            ("设备维护主管", "maintenance_supervisor", "设备管理与维修计划"),
            // 质量域
            ("质量管理经理", "qc_manager", "质量体系管理与8D流程协调"),
            ("质检员", "quality_inspector", "质量检验与异常处理"),
            ("验布员", "fabric_inspector", "面料检验与十项物理指标检测"),
            // 财务域
            ("财务经理", "finance_manager", "财务管理与凭证审批"),
            ("会计", "accountant", "会计凭证录入与对账"),
            ("出纳", "cashier", "资金收付与银行对账"),
            ("成本会计", "cost_accountant", "成本核算与成本分析"),
            // CRM 域
            ("CRM经理", "crm_manager", "CRM管理与客户分配"),
            ("CRM专员", "crm_rep", "线索跟进与商机管理"),
            // 物流域
            ("物流协调员", "logistics_coordinator", "运单管理与物流跟踪"),
            ("报关专员", "customs_specialist", "进出口报关与贸易合规"),
            // 人力资源域
            ("人事经理", "hr_manager", "员工管理与考勤工资审批"),
            ("人事专员", "hr_specialist", "员工档案与考勤录入"),
            // 安全环保域
            ("安全环保专员", "safety_officer", "安全生产与环保合规"),
            // IT/数据域
            ("系统管理员", "system_admin", "系统配置与用户管理"),
            ("数据分析师", "data_analyst", "BI报表与数据分析"),
            // 行政
    ...
    async fn create_default_role_permissions(&self) -> Result<(), InitError> {
        ...
        let role_permissions: &[(&str, &[(&str, &str)])] = &[
            ...
            // 管理层
            ("gm", &[("users", "read"), ("products", "read"), ("orders", "read"), ("customers", "read"), ("suppliers", "read"), ("inventory", "read"), ("vouchers", "read"), ("ar", "read"), ("ap", "read"), ("gl", "read"), ("reports", "read")]),
            ("deputy_gm", &[("users", "read"), ("products", "read"), ("orders", "read"), ("customers", "read"), ("suppliers", "read"), ("inventory", "read"), ("vouchers", "read"), ("ar", "read"), ("ap", "read"), ("gl", "read"), ("reports", "read")]),
            // 销售域
            ...
            ("sourcing_specialist", &[("suppliers", "read"), ("suppliers", "create"), ("purchase-prices", "*")]),
            // 库存仓储域
            ...
            ("finishing_master", &[("production-orders", "read"), ("production-orders", "create"), ("production-orders", "update"), ("dye-batches", "read")]),
            ("lab_technician", &[("dye-recipes", "*"), ("dye-batches", "read"), ("color-cards", "*")]),
            ("greige_manager", &[("greige-fabrics", "*"), ("outsourcing-orders", "*"), ("inventory", "read")]),
            ("chemical_manager", &[("chemicals", "*"), ("purchase-orders", "read"), ("inventory", "read")]),
            ("maintenance_supervisor", &[("equipment", "*"), ("maintenance-records", "*"), ("production-orders", "read")]),
            // 质量域
            ("qc_manager", &[("quality-inspections", "*"), ("quality-issues", "*"), ("dye-batches", "read"), ("reports", "read")]),
            ("quality_inspector", &[("quality-inspections", "*"), ("dye-batches", "read")]),
            ("fabric_inspector", &[("fabric-inspections", "*"), ("dye-batches", "read"), ("products", "read")]),
            // 财务域
            ("finance_manager", &[("vouchers", "*"), ("ar", "*"), ("ap", "*"), ("gl", "*"), ("budgets", "*")]),
            ("accountant", &[("vouchers", "*"), ("gl", "read"), ("gl", "create"), ("ar", "read"), ("ar", "create"), ("ap", "read"), ("ap", "create")]),
            ("cashier", &[("fund-transfers", "read"), ("fund-transfers", "create"), ("ar", "read"), ("ap", "read")]),
            ("cost_accountant", &[("cost-collections", "*"), ("vouchers", "read"), ("vouchers", "create"), ("dye-batches", "read")]),
            // CRM 域
            ...
            // 物流域
            ("logistics_coordinator", &[("logistics", "*"), ("ship-orders", "read"), ("ship-orders", "create"), ("orders", "read")]),
            ("customs_specialist", &[("logistics", "read"), ("incoterms", "read"), ("orders", "read")]),
            // 人力资源域
            ("hr_manager", &[("employees", "*"), ("departments", "*"), ("wages", "*")]),
            ("hr_specialist", &[("employees", "read"), ("employees", "create"), ("employees", "update"), ("departments", "read")]),
            // 安全环保域
            ("safety_officer", &[("safety-records", "*"), ("environmental-records", "*"), ("reports", "read")]),
            // IT/数据域
            ("system_admin", &[("users", "*"), ("roles", "*"), ("departments", "*"), ("system-config", "*")]),
            ("data_analyst", &[("reports", "*"), ("bi-analysis", "*"), ("dashboard", "read")]),
            // 行政
