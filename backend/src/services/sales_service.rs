...
impl SalesService {
    ...
    pub async fn create_order(
        ...
        let order = sales_order::ActiveModel {
            ...
            delivery_type: sea_orm::ActiveValue::Set(Some("一次性交货".to_string())),
            partial_delivery_allowed: sea_orm::ActiveValue::Set(Some(false)),
            max_partial_count: sea_orm::ActiveValue::Set(None),
            quality_standard: sea_orm::ActiveValue::Set(request.quality_standard),
            inspection_standard: sea_orm::ActiveValue::Set(None),
            packaging_requirement: sea_orm::ActiveValue::Set(request.packaging_requirement),
            shipping_mark: sea_orm::ActiveValue::Set(None),
