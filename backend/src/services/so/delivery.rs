...
struct ShipOrderContext {
    order: sales_order::Model,
    order_items: Vec<sales_order_item::Model>,
    product_map: std::collections::HashMap<i32, crate::models::product::Model>,
    warehouse: warehouse::Model,
    shipped_items_snapshot: Vec<(i32, rust_decimal::Decimal)>,
}

/// 发货明细处理结果：金额累计 + 待发布事件
struct ShipmentItemsResult {
    delivery_total_amount: Decimal,
    delivery_total_tax: Decimal,
    pending_inventory_events: Vec<crate::services::event_bus::BusinessEvent>,
}
...
impl SalesService {
    ...
    fn order_to_csv_row(o: super::SalesOrderDetail) -> std::collections::HashMap<String, String> {
