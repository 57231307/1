...
const SUPPORTED_CURRENCY_CODES: &[&str] = &[
    "USD", "EUR", "CNY", "JPY", "GBP", "AUD", "CAD", "CHF", "HKD", "SGD", "KRW", "INR", "BRL",
    "RUB", "ZAR", "MXN", "NZD", "SEK", "NOK", "DKK", "PLN", "CZK", "HUF", "TRY", "ILS", "AED",
    "SAR", "THB", "IDR", "MYR", "PHP", "VND", "TWD", "KZT", "UAH", "RON", "BGN", "HRK", "ISK",
    "MTL",
];
