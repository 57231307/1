...
impl ReportEngineService {
    ...
    /// 销售汇总报表模板
    fn sales_summary_template() -> ReportTemplate {
    ...
    /// 采购汇总报表模板
    fn purchase_summary_template() -> ReportTemplate {
    ...
    /// 应收账款账龄分析报表模板
    fn ar_aging_template() -> ReportTemplate {
        use super::ReportColumn as Rc;
        ReportTemplate {
    ...
    /// 畅销产品报表模板
    fn top_products_template() -> ReportTemplate {
        use super::{ReportColumn as Rc, ReportFilter as Rf, ReportParameter as Rp};
        ReportTemplate {
    ...
    /// 客户分析报表模板
    fn customer_analysis_template() -> ReportTemplate {
        use super::{ReportColumn as Rc, ReportFilter as Rf};
        ReportTemplate {
    ...
    /// 库存周转率报表模板
    fn inventory_turnover_template() -> ReportTemplate {
        use super::{ReportColumn as Rc, ReportFilter as Rf};
        ReportTemplate {
