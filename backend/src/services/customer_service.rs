...
impl CustomerService {
    ...
    pub async fn create_customer(
        ...
        let customer = customer::ActiveModel {
            ...
            customer_industry: sea_orm::ActiveValue::Set(None),
            main_products: sea_orm::ActiveValue::Set(None),
            annual_purchase: sea_orm::ActiveValue::Set(None),
            quality_requirement: sea_orm::ActiveValue::Set(None),
