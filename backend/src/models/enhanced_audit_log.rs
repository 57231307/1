...
#[derive(Copy, Clone, Debug, EnumIter, DeriveRelation)]
pub enum SecurityRelation {}

impl ActiveModelBehavior for SecurityActiveModel {}
...
#[derive(Copy, Clone, Debug, EnumIter, DeriveRelation)]
pub enum PerformanceRelation {}

impl ActiveModelBehavior for PerformanceActiveModel {}
...
#[derive(Copy, Clone, Debug, EnumIter, DeriveRelation)]
pub enum HealthRelation {}

impl ActiveModelBehavior for HealthActiveModel {}
...
impl ActiveModelBehavior for BusinessActiveModel {}
