...
CREATE INDEX idx_vouchers_batch ON vouchers(batch_no, color_no);
...
CREATE INDEX idx_voucher_items_batch ON voucher_items(assist_batch_id, assist_color_no_id);
...
CREATE UNIQUE INDEX idx_accounting_periods_year_period ON accounting_periods(year, period);
