...
('admin', 'ADMIN', '系统管理员', '["*"]', true),
('manager', 'MANAGER', '部门经理', '["user:view", "product:*", "inventory:*", "sales:*"]', false),
('operator', 'OPERATOR', '操作员', '["product:view", "inventory:view", "sales:view"]', false)
...
CREATE TABLE IF NOT EXISTS batch_trace_log (
    ...
    operation_time TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP, -- 操作时间
...
CREATE TABLE IF NOT EXISTS bpm_task_notification (
    ...
    -- 系统字段
    sent_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP, -- 发送时间
    created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS log_system (
    ...
    -- 时间信息
    log_time TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP, -- 日志时间
...
CREATE TABLE IF NOT EXISTS log_login (
    ...
    -- 时间信息
    login_time TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP, -- 登录时间
...
CREATE TABLE IF NOT EXISTS log_api_access (
    ...
    -- 时间信息
    access_time TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP, -- 访问时间
...
CREATE TABLE IF NOT EXISTS crm_customer_sea (
    ...
    -- 时间信息
    released_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP, -- 释放时间
...
CREATE TABLE IF NOT EXISTS oa_message (
    ...
    send_time TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP, -- 发送时间
...
CREATE TABLE IF NOT EXISTS report_export_history (
    ...
    -- 时间信息
    requested_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP, -- 请求时间
    completed_at TIMESTAMPTZ,                              -- 完成时间
    expires_at TIMESTAMPTZ,                                -- 过期时间
...
ALTER TABLE log_system ADD COLUMN IF NOT EXISTS params TEXT;
...
ALTER TABLE sales_order_items ADD COLUMN IF NOT EXISTS total_amount DECIMAL(12,2);
...
ALTER TABLE budget_executions ADD COLUMN IF NOT EXISTS plan_id INTEGER NOT NULL DEFAULT 0;
ALTER TABLE budget_executions ADD COLUMN IF NOT EXISTS execution_type VARCHAR(50) NOT NULL DEFAULT '';
ALTER TABLE budget_executions ADD COLUMN IF NOT EXISTS amount DECIMAL(18,2) NOT NULL DEFAULT 0;
ALTER TABLE budget_executions ADD COLUMN IF NOT EXISTS expense_type VARCHAR(100);
ALTER TABLE budget_executions ADD COLUMN IF NOT EXISTS expense_date DATE NOT NULL DEFAULT CURRENT_DATE;
ALTER TABLE budget_executions ADD COLUMN IF NOT EXISTS related_document_type VARCHAR(50);
ALTER TABLE budget_executions ADD COLUMN IF NOT EXISTS related_document_id INTEGER;
ALTER TABLE budget_executions ADD COLUMN IF NOT EXISTS remark TEXT;
ALTER TABLE budget_executions ADD COLUMN IF NOT EXISTS created_by INTEGER;

ALTER TABLE business_trace_assist_links ADD COLUMN IF NOT EXISTS trace_id INTEGER NOT NULL DEFAULT 0;
ALTER TABLE business_trace_assist_links ADD COLUMN IF NOT EXISTS assist_type VARCHAR(50) NOT NULL DEFAULT '';
ALTER TABLE business_trace_assist_links ADD COLUMN IF NOT EXISTS assist_id INTEGER NOT NULL DEFAULT 0;
ALTER TABLE business_trace_assist_links ADD COLUMN IF NOT EXISTS assist_code VARCHAR(100);
ALTER TABLE business_trace_assist_links ADD COLUMN IF NOT EXISTS assist_name VARCHAR(200);
ALTER TABLE business_trace_assist_links ADD COLUMN IF NOT EXISTS remarks TEXT;

ALTER TABLE business_traces ADD COLUMN IF NOT EXISTS batch_no VARCHAR(50) NOT NULL DEFAULT '';
ALTER TABLE business_traces ADD COLUMN IF NOT EXISTS product_id INTEGER NOT NULL DEFAULT 0;
ALTER TABLE business_traces ADD COLUMN IF NOT EXISTS warehouse_id INTEGER NOT NULL DEFAULT 0;
ALTER TABLE business_traces ADD COLUMN IF NOT EXISTS current_stage VARCHAR(50) NOT NULL DEFAULT '';
ALTER TABLE business_traces ADD COLUMN IF NOT EXISTS quantity DECIMAL(18,4) NOT NULL DEFAULT 0;
ALTER TABLE business_traces ADD COLUMN IF NOT EXISTS unit VARCHAR(20) NOT NULL DEFAULT '';
ALTER TABLE business_traces ADD COLUMN IF NOT EXISTS remarks TEXT;

ALTER TABLE dye_batch ADD COLUMN IF NOT EXISTS batch_no VARCHAR(50) NOT NULL DEFAULT '';
ALTER TABLE dye_batch ADD COLUMN IF NOT EXISTS color_code VARCHAR(50) NOT NULL DEFAULT '';
ALTER TABLE dye_batch ADD COLUMN IF NOT EXISTS color_name VARCHAR(100) NOT NULL DEFAULT '';
ALTER TABLE dye_batch ADD COLUMN IF NOT EXISTS fabric_type VARCHAR(100);
ALTER TABLE dye_batch ADD COLUMN IF NOT EXISTS weight_kg DECIMAL(18,4);
ALTER TABLE dye_batch ADD COLUMN IF NOT EXISTS status VARCHAR(20) NOT NULL DEFAULT '';
ALTER TABLE dye_batch ADD COLUMN IF NOT EXISTS production_date TIMESTAMPTZ;
ALTER TABLE dye_batch ADD COLUMN IF NOT EXISTS completion_date TIMESTAMPTZ;
ALTER TABLE dye_batch ADD COLUMN IF NOT EXISTS quality_grade VARCHAR(50);
ALTER TABLE dye_batch ADD COLUMN IF NOT EXISTS remarks TEXT;
ALTER TABLE dye_batch ADD COLUMN IF NOT EXISTS created_by INTEGER;

ALTER TABLE dye_recipe ADD COLUMN IF NOT EXISTS recipe_no VARCHAR(50) NOT NULL DEFAULT '';
ALTER TABLE dye_recipe ADD COLUMN IF NOT EXISTS color_code VARCHAR(50) NOT NULL DEFAULT '';
ALTER TABLE dye_recipe ADD COLUMN IF NOT EXISTS color_name VARCHAR(100) NOT NULL DEFAULT '';
...
ALTER TABLE dye_recipe ADD COLUMN IF NOT EXISTS temperature DECIMAL(18,4);
ALTER TABLE dye_recipe ADD COLUMN IF NOT EXISTS time_minutes INTEGER;
ALTER TABLE dye_recipe ADD COLUMN IF NOT EXISTS ph_value DECIMAL(18,4);
ALTER TABLE dye_recipe ADD COLUMN IF NOT EXISTS liquor_ratio DECIMAL(18,4);
ALTER TABLE dye_recipe ADD COLUMN IF NOT EXISTS auxiliaries JSONB;
ALTER TABLE dye_recipe ADD COLUMN IF NOT EXISTS status VARCHAR(20) NOT NULL DEFAULT '';
...
ALTER TABLE dye_recipe ADD COLUMN IF NOT EXISTS created_by INTEGER;

ALTER TABLE fixed_asset_disposals ADD COLUMN IF NOT EXISTS disposal_no VARCHAR(50) NOT NULL DEFAULT '';
ALTER TABLE fixed_asset_disposals ADD COLUMN IF NOT EXISTS asset_id INTEGER NOT NULL DEFAULT 0;
ALTER TABLE fixed_asset_disposals ADD COLUMN IF NOT EXISTS disposal_date DATE NOT NULL DEFAULT CURRENT_DATE;
ALTER TABLE fixed_asset_disposals ADD COLUMN IF NOT EXISTS disposal_type VARCHAR(20) NOT NULL DEFAULT '';
ALTER TABLE fixed_asset_disposals ADD COLUMN IF NOT EXISTS quantity INTEGER NOT NULL DEFAULT 0;
ALTER TABLE fixed_asset_disposals ADD COLUMN IF NOT EXISTS disposal_amount DECIMAL(18,2) NOT NULL DEFAULT 0;
ALTER TABLE fixed_asset_disposals ADD COLUMN IF NOT EXISTS disposal_reason TEXT NOT NULL DEFAULT '';
ALTER TABLE fixed_asset_disposals ADD COLUMN IF NOT EXISTS status VARCHAR(20) NOT NULL DEFAULT '';
ALTER TABLE fixed_asset_disposals ADD COLUMN IF NOT EXISTS remarks TEXT;
ALTER TABLE fixed_asset_disposals ADD COLUMN IF NOT EXISTS created_by INTEGER NOT NULL DEFAULT 0;

ALTER TABLE fund_transfer_records ADD COLUMN IF NOT EXISTS transfer_no VARCHAR(50) NOT NULL DEFAULT '';
ALTER TABLE fund_transfer_records ADD COLUMN IF NOT EXISTS from_account_id INTEGER NOT NULL DEFAULT 0;
ALTER TABLE fund_transfer_records ADD COLUMN IF NOT EXISTS to_account_id INTEGER NOT NULL DEFAULT 0;
ALTER TABLE fund_transfer_records ADD COLUMN IF NOT EXISTS transfer_date DATE NOT NULL DEFAULT CURRENT_DATE;
ALTER TABLE fund_transfer_records ADD COLUMN IF NOT EXISTS amount DECIMAL(18,2) NOT NULL DEFAULT 0;
ALTER TABLE fund_transfer_records ADD COLUMN IF NOT EXISTS status VARCHAR(20) NOT NULL DEFAULT '';
ALTER TABLE fund_transfer_records ADD COLUMN IF NOT EXISTS remarks TEXT;
ALTER TABLE fund_transfer_records ADD COLUMN IF NOT EXISTS created_by INTEGER NOT NULL DEFAULT 0;

ALTER TABLE greige_fabric ADD COLUMN IF NOT EXISTS fabric_no VARCHAR(50) NOT NULL DEFAULT '';
ALTER TABLE greige_fabric ADD COLUMN IF NOT EXISTS fabric_name VARCHAR(200) NOT NULL DEFAULT '';
ALTER TABLE greige_fabric ADD COLUMN IF NOT EXISTS fabric_type VARCHAR(100) NOT NULL DEFAULT '';
ALTER TABLE greige_fabric ADD COLUMN IF NOT EXISTS color_code VARCHAR(50);
ALTER TABLE greige_fabric ADD COLUMN IF NOT EXISTS width_cm DECIMAL(18,4);
ALTER TABLE greige_fabric ADD COLUMN IF NOT EXISTS weight_kg DECIMAL(18,4);
ALTER TABLE greige_fabric ADD COLUMN IF NOT EXISTS length_m DECIMAL(18,4);
ALTER TABLE greige_fabric ADD COLUMN IF NOT EXISTS supplier_id INTEGER;
ALTER TABLE greige_fabric ADD COLUMN IF NOT EXISTS batch_no VARCHAR(50);
ALTER TABLE greige_fabric ADD COLUMN IF NOT EXISTS warehouse_id INTEGER;
ALTER TABLE greige_fabric ADD COLUMN IF NOT EXISTS location VARCHAR(200);
ALTER TABLE greige_fabric ADD COLUMN IF NOT EXISTS status VARCHAR(20) NOT NULL DEFAULT '';
ALTER TABLE greige_fabric ADD COLUMN IF NOT EXISTS quality_grade VARCHAR(50);
ALTER TABLE greige_fabric ADD COLUMN IF NOT EXISTS purchase_date TIMESTAMPTZ;
ALTER TABLE greige_fabric ADD COLUMN IF NOT EXISTS remarks TEXT;
ALTER TABLE greige_fabric ADD COLUMN IF NOT EXISTS created_by INTEGER;

ALTER TABLE log_api_accesses ADD COLUMN IF NOT EXISTS user_id INTEGER;
ALTER TABLE log_api_accesses ADD COLUMN IF NOT EXISTS username VARCHAR(100);
ALTER TABLE log_api_accesses ADD COLUMN IF NOT EXISTS method VARCHAR(20) NOT NULL DEFAULT '';
ALTER TABLE log_api_accesses ADD COLUMN IF NOT EXISTS path TEXT NOT NULL DEFAULT '';
ALTER TABLE log_api_accesses ADD COLUMN IF NOT EXISTS query_params TEXT;
ALTER TABLE log_api_accesses ADD COLUMN IF NOT EXISTS request_body TEXT;
ALTER TABLE log_api_accesses ADD COLUMN IF NOT EXISTS status_code INTEGER;
ALTER TABLE log_api_accesses ADD COLUMN IF NOT EXISTS response_size BIGINT;
ALTER TABLE log_api_accesses ADD COLUMN IF NOT EXISTS execution_time BIGINT NOT NULL DEFAULT 0;
ALTER TABLE log_api_accesses ADD COLUMN IF NOT EXISTS ip_address VARCHAR(50);
ALTER TABLE log_api_accesses ADD COLUMN IF NOT EXISTS user_agent TEXT;
ALTER TABLE log_api_accesses ADD COLUMN IF NOT EXISTS error_message TEXT;

ALTER TABLE purchase_contract_executions ADD COLUMN IF NOT EXISTS execution_no VARCHAR(50) NOT NULL DEFAULT '';
ALTER TABLE purchase_contract_executions ADD COLUMN IF NOT EXISTS contract_id INTEGER NOT NULL DEFAULT 0;
ALTER TABLE purchase_contract_executions ADD COLUMN IF NOT EXISTS execution_date DATE NOT NULL DEFAULT CURRENT_DATE;
ALTER TABLE purchase_contract_executions ADD COLUMN IF NOT EXISTS execution_type VARCHAR(20) NOT NULL DEFAULT '';
ALTER TABLE purchase_contract_executions ADD COLUMN IF NOT EXISTS quantity DECIMAL(18,4) NOT NULL DEFAULT 0;
ALTER TABLE purchase_contract_executions ADD COLUMN IF NOT EXISTS amount DECIMAL(18,2) NOT NULL DEFAULT 0;
ALTER TABLE purchase_contract_executions ADD COLUMN IF NOT EXISTS status VARCHAR(20) NOT NULL DEFAULT '';
ALTER TABLE purchase_contract_executions ADD COLUMN IF NOT EXISTS remarks TEXT;
ALTER TABLE purchase_contract_executions ADD COLUMN IF NOT EXISTS created_by INTEGER NOT NULL DEFAULT 0;

ALTER TABLE sales_contract_executions ADD COLUMN IF NOT EXISTS contract_id INTEGER NOT NULL DEFAULT 0;
ALTER TABLE sales_contract_executions ADD COLUMN IF NOT EXISTS execution_type VARCHAR(50) NOT NULL DEFAULT '';
ALTER TABLE sales_contract_executions ADD COLUMN IF NOT EXISTS execution_amount DECIMAL(18,2) NOT NULL DEFAULT 0;
ALTER TABLE sales_contract_executions ADD COLUMN IF NOT EXISTS related_bill_type VARCHAR(50);
ALTER TABLE sales_contract_executions ADD COLUMN IF NOT EXISTS related_bill_id INTEGER;
ALTER TABLE sales_contract_executions ADD COLUMN IF NOT EXISTS remark TEXT;
ALTER TABLE sales_contract_executions ADD COLUMN IF NOT EXISTS created_by INTEGER;

ALTER TABLE sales_return ADD COLUMN IF NOT EXISTS return_no VARCHAR(50) NOT NULL DEFAULT '';
ALTER TABLE sales_return ADD COLUMN IF NOT EXISTS sales_order_id INTEGER;
ALTER TABLE sales_return ADD COLUMN IF NOT EXISTS customer_id INTEGER NOT NULL DEFAULT 0;
ALTER TABLE sales_return ADD COLUMN IF NOT EXISTS return_date DATE NOT NULL DEFAULT CURRENT_DATE;
ALTER TABLE sales_return ADD COLUMN IF NOT EXISTS warehouse_id INTEGER NOT NULL DEFAULT 0;
ALTER TABLE sales_return ADD COLUMN IF NOT EXISTS reason TEXT NOT NULL DEFAULT '';
ALTER TABLE sales_return ADD COLUMN IF NOT EXISTS status VARCHAR(20) NOT NULL DEFAULT '';
ALTER TABLE sales_return ADD COLUMN IF NOT EXISTS total_amount DECIMAL(18,2) NOT NULL DEFAULT 0;
ALTER TABLE sales_return ADD COLUMN IF NOT EXISTS remarks TEXT;
ALTER TABLE sales_return ADD COLUMN IF NOT EXISTS approved_by INTEGER;
ALTER TABLE sales_return ADD COLUMN IF NOT EXISTS approved_at TIMESTAMPTZ;
ALTER TABLE sales_return ADD COLUMN IF NOT EXISTS rejected_reason TEXT;
ALTER TABLE sales_return ADD COLUMN IF NOT EXISTS created_by INTEGER NOT NULL DEFAULT 0;

ALTER TABLE sales_return_item ADD COLUMN IF NOT EXISTS return_id INTEGER NOT NULL DEFAULT 0;
ALTER TABLE sales_return_item ADD COLUMN IF NOT EXISTS line_no INTEGER NOT NULL DEFAULT 0;
ALTER TABLE sales_return_item ADD COLUMN IF NOT EXISTS product_id INTEGER NOT NULL DEFAULT 0;
ALTER TABLE sales_return_item ADD COLUMN IF NOT EXISTS quantity DECIMAL(18,4) NOT NULL DEFAULT 0;
ALTER TABLE sales_return_item ADD COLUMN IF NOT EXISTS quantity_alt DECIMAL(18,4) NOT NULL DEFAULT 0;
ALTER TABLE sales_return_item ADD COLUMN IF NOT EXISTS unit_price DECIMAL(18,6) NOT NULL DEFAULT 0;
ALTER TABLE sales_return_item ADD COLUMN IF NOT EXISTS unit_price_foreign DECIMAL(18,6) NOT NULL DEFAULT 0;
ALTER TABLE sales_return_item ADD COLUMN IF NOT EXISTS discount_percent DECIMAL(5,2) NOT NULL DEFAULT 0;
ALTER TABLE sales_return_item ADD COLUMN IF NOT EXISTS tax_percent DECIMAL(5,2) NOT NULL DEFAULT 0;
ALTER TABLE sales_return_item ADD COLUMN IF NOT EXISTS subtotal DECIMAL(18,2) NOT NULL DEFAULT 0;
ALTER TABLE sales_return_item ADD COLUMN IF NOT EXISTS tax_amount DECIMAL(18,2) NOT NULL DEFAULT 0;
ALTER TABLE sales_return_item ADD COLUMN IF NOT EXISTS discount_amount DECIMAL(18,2) NOT NULL DEFAULT 0;
ALTER TABLE sales_return_item ADD COLUMN IF NOT EXISTS total_amount DECIMAL(18,2) NOT NULL DEFAULT 0;
ALTER TABLE sales_return_item ADD COLUMN IF NOT EXISTS notes TEXT;

ALTER TABLE system_version ADD COLUMN IF NOT EXISTS version VARCHAR(50) NOT NULL DEFAULT '';
ALTER TABLE system_version ADD COLUMN IF NOT EXISTS release_date TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP;
